...
* **admin:** admin freeze/unfreeze подписки пользователя (задача 11) ([0d18758](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0d1875840a36c93d4dc50d29a52bd83f9e43d68a))
...
* **API:** POST /cabinet/subscription/freeze|unfreeze — эндпоинты заморозки ([ee656e9](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ee656e9001e4f7036dcbab1b5c259353a86e2fb0))
...
* **balance:** готовые суммы пополнения из цен действующих тарифов ([4752aec](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4752aec8c60b889d101144de9613d04315bbf569))
...
* **cabinet:** длинный access-TTL для админов, чтобы сессию не закрывало ([6ce4790](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6ce47901edcdb41cad6ee299117c81b45b6f8204))
* **cabinet:** колонка cabinet_ui_mode — персональный выбор интерфейса ([187fb43](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/187fb4362fb76e92c549b73a7126b44a90ec28fb))
...
* **cabinet:** поэтапная раскатка — per-user флаг доступа и глобальный переключатель ([f12fa28](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f12fa28a5a0789353248d24dba0457d1bcf0fdcf))
* **cabinet:** поэтапная раскатка ЛК — скрытие кнопок и admin-переключение per-user ([324a2d1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/324a2d1a3a5754f26c9d74101104296c7e45b390))
* **cabinet:** резолвинг эффективного режима интерфейса ([f128669](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f128669e374088f28effc443708e9f70d97478e0))
...
* **cabinet:** удаление конкретной подписки из карточки пользователя ([56a9959](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/56a9959d7738d6b646bcfd001b5de265a683b604))
...
* **cabinet:** эндпоинты выбора интерфейса и поле в профиле ([42a5c61](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/42a5c6102a18829107de0d50d7208b71932575a9))
...
* **crud:** фильтр is_frozen в get_expired_subscriptions + get_subscriptions_for_auto_unfreeze ([c423635](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c42363572b97cfc0702bdade08506469a7982d4c))
...
* **devices:** выборочное отключение нескольких устройств одним запросом ([50e7546](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/50e754621dec3b25963378591a0eb39b53dcf7f3))
...
* **devices:** название клиентского приложения в списке устройств ([d839d49](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d839d4916e05cc98b7c69a0a46d00a16b18b5c6d))
* **devices:** уменьшение лимита с выбором устройств и возвратом денег ([c3be677](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c3be677a47ac6ae1b728d3de6f7f69e7a77db167))
...
* **email:** заголовок Reply-To (SMTP_REPLY_TO) ([6a26e39](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6a26e397d3b2366d5bc24a48af3b2c6c49f5dba5))
* **email:** отписка от маркетинговых писем (one-click, RFC 8058) ([4825527](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/482552705400a44e8afb83904a310875fa4261fb))
* **freeze:** multi-tariff sub_id в эндпоинтах и боте; freeze_min_days_remaining для фронта ([3285776](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3285776d2fa700f72ad3f6fad3cc44435db69fe4))
* **gift:** перевод суммы подарка в дни по цене получателя ([5a19ee5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5a19ee5f6788688c2f036446f305f6efca8a99d8))
* **gift:** предупреждаем дарителя, что подарок зачтётся по цене получателя ([664f2bf](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/664f2bf1081098903c35ed5f7cfc20037e13dbd2))
...
* **landing:** засчитывать гостевую покупку в рекламную кампанию ([1c46702](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1c46702cdf18c437c71de6d0129a65cdfa0f4794))
* **landing:** засчитывать гостевые покупки в рекламные кампании ([7203ca9](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7203ca9f88cf5f37d82cdb0476f417799d621a6e))
* **landing:** сохранять слаг рекламной кампании в гостевой покупке ([4a81705](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4a81705d277c5e2fd92da47907e04cf8b4abb590))
...
* **pricing:** общий модуль расшифровки цены и правка формулировок про устройства ([3b2de55](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3b2de55a11ce10c3bdb179a3416854bae6d8de86))
* **pricing:** показываем, из чего сложилась цена, в боте и кабинете ([13cfdc4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/13cfdc49f89b13f73af7a95d11369d2bf30bc4cf))
...
* **promocodes:** трафик в наборе бонусов промокода ([93f5bff](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/93f5bff49691847284e8d8bb12650bffaef92084))
...
* **remnawave:** проксировать GeoCheck ноды из панели 3.3.0 в кабинет ([134d8e4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/134d8e4ef828d138bc74a4608af9ee64c15e6e98))
...
* **repair:** скрипт компенсации для застрявших в fallback-скваде после оплаты ([a416af3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a416af31c6fd3c395b7ce01374610b430c0fe9e3))
* **scripts:** разовая уборка застрявших в fallback-скваде ([8f272a0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8f272a04ac35852a2f9fb6ec202a4be1048bba41))
...
* **sponsored:** продление умеет списывать с одного, а продлевать другому ([4b166e0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4b166e0955967f8931d612368da862cbeda025c2))
* **sponsored:** резолвер получателя по @нику, telegram id или email ([8486658](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8486658af393b72b28ad706a60d2c408ddacd26a))
* **sponsored:** таблица sponsored_payments для оплаты за другого ([3ddcd24](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3ddcd24684e8fadbbed152870acfe942c9daec25))
...
* **бот:** хендлеры заморозки/разморозки подписки через Telegram ([52acec4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/52acec4c78b7332dcc121583d40f3559743db2dd))
* **конфиг:** FREEZE_SUBSCRIPTIONS_ENABLED, FREEZE_MAX_DAYS, FREEZE_MIN_DAYS_REMAINING ([77beb67](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/77beb67429374165c1b580b8ecffc49505145cce))
* **миграция:** 9030 — поля заморозки подписки ([c51a19e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c51a19e4f7cfbfd4bfa5941264816d90334b366d))
* **модель:** freeze-поля подписки (is_frozen, frozen_at, frozen_days_banked, frozen_auto_unfreeze_at) ([929f62c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/929f62c3cedd2705da3e2e101be26b5569cbadf6))
* **мониторинг:** авто-разморозка подписок по истечении FREEZE_MAX_DAYS ([e4cc707](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e4cc70711382863c719da669576d5d4630f35b84))
* **сервис:** FreezeNotAllowedError, _validate_freeze_preconditions, freeze_subscription, unfreeze_subscription ([9ae7fe7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9ae7fe7d4769f3ef33b07f48789938ee0af39d70))
* **уведомления:** SUBSCRIPTION_FROZEN/UNFROZEN — типы и методы уведомления о заморозке ([39f7fe8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/39f7fe862fd020fc8a89cdb5d38b6fe747b3e5a4))
...
* **API:** добавить freeze_subscriptions_enabled в SubscriptionData ([7e891dd](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7e891dd5dc1c21730839189fc98bdee78b057dfb))
...
* **autopay:** продлевало на месяц, хотя денег хватало на три ([1a22625](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1a226255478a6fb7d306b2268ab1e3c010a7c957))
...
* **bans:** уважать общий выключатель уведомлений в типизированных банах ([927790f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/927790fd4d674e32a4824c9778801d63bb360393))
* **ban:** уведомление о бане не доходило никогда — поиск шёл по несуществующей колонке ([e915262](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e9152621847c8f0be220f620d46308c7f434d4a2))
...
* **cabinet:** CABINET_OPEN_TO_ALL по умолчанию включён — доступ открыт всем ([e9e2409](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e9e24098675a2a57731f6766a3bb632f216c168c))
* **cabinet:** id админа снимаем до цикла массового действия ([9fba46f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9fba46f4e4820d6aacd3a459ff2bf6bfdab1a228))
...
* **cabinet:** возврат за устройства без скидки аддонов, циклы удаления без таймаута ([5f90601](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5f90601806201bd1448d9f7b01d6f6944432c004))
* **cabinet:** восстановить таймаут панельной синхронизации в purchase.py ([cbeed6d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cbeed6dbea1a10fe6a20ddb5d81de4ff1a383532))
...
* **cabinet:** готовые суммы пополнения пропадали для суточных тарифов ([eafad70](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/eafad70b021e7bfc3121078cebdc1055736e0dfc))
...
* **cabinet:** не отвергать вход по возрасту залипшего Telegram initData ([d9a573e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d9a573e4db893b0c0b21efd78c1e384da3b05c2c))
* **cabinet:** не отдавать пустую строку вместо null в /info/service ([1707660](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1707660636fdf86547a891064ad9ec4f0f6bfafc))
* **cabinet:** отдавать в /info/service реальные настройки ([0ba8fa5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0ba8fa56bbf778e79b4cec52cde46dcc38d5e4a4))
* **cabinet:** отдавать в /info/service реальные настройки ([3329ec3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3329ec33cf824cc8568f09f01a709be6cba9b3aa))
...
* **cabinet:** превью возврата за устройства расходилось с фактическим начислением ([105ce6b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/105ce6b6f1c78b7cd072966ff06473f18dfb9ec1))
...
* **cabinet:** три находки ревью по волне 2 — промогруппа, тег роутера, обёртка ошибок ([bf927ed](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bf927ed3b169ce9e8881aee52de2e699f56b961f))
* **cabinet:** убран ошибочный гейт доступа к ЛК, ломавший прод ([9600639](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/96006391e8743dec3725403503f38478873badb7))
* **cabinet:** удаление подписки адресует панельный аккаунт по режиму ([1feef2c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1feef2c55835de2256eb114d3814417aac23d38f))
* **cabinet:** удаление подписки в массовых действиях падало MissingGreenlet ([c99fd54](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c99fd544fa822eec7190c8461a1179b984d2b915))
...
* **channel:** не слать админам traceback на заблокировавших бота ([d91caee](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d91caeeee24d6be463c5f0efb502f10e7016cac2))
...
* **devices:** безлимит устройств не выживал внутри бота и превращался в «1» ([1c0ce1f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1c0ce1fb0965b65bdd1b550229b7274093902534))
...
* **email:** отписку применяет только POST + границы токена ([091e2ee](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/091e2ee95fd4709f26b521bbc4a05a750a65eb65))
* **email:** промо-рассылка топила письма входа и попадала под антиспам ([4f2c9cd](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4f2c9cd02af804f74369e763768cc7030c6afd4d))
* **fallback:** _patch_user_full верифицирует применение сквада и в happy-path ([5fb1064](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5fb10647ee5134d82922a66ecb32eeed84c51dfa))
* **fallback:** reconcile восстанавливает ВСЕХ застрявших через истину панели ([0a30d10](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0a30d103b4d328b86c94bb4c180d2dddf48421f5))
* **fallback:** два бага застревания в fallback после автопокупки и переплаты ([8397645](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/839764579e435694bf11d6038c70a54432acbcc6))
* **fallback:** оплата не вытаскивала из fallback-сквада, если connected_squads пуст ([9c8c01f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9c8c01faaf129d61e2508f162fd96e2a9d867881))
* **fallback:** резолвить панельную идентичность через юзера, а не только по колонкам подписки ([8419ef3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8419ef35988fd0f6acc4aff98382165a96af0d1d))
* **fallback:** человек не возвращался из fallback-сквада после продления ([965a29b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/965a29b9dc160ae562a4d039d7445141a1f11d99))
* **freeze:** сбой панели при разморозке больше не оставляет юзера DISABLED навсегда ([b723639](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b723639950fc7c519b2faff2221e82421ecf02f6))
* **freeze:** финальные правки фичи заморозки подписки ([a92f35d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a92f35d5d3e1008c11bd25f1dd2f8e3238dbf54d))
* **gift:** подарок обнулял получателю лимит устройств ([2ccfdda](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2ccfdda14cb1965bfbf11ee62831d5b12cef9e2e))
* **grace:** сессия без панельного id чинится при чтении, а не живёт вечно ([5116848](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/51168487da3f51a256e59abe9655fcc8ebee0364))
* **handlers:** разорвать циклический импорт backup_login_nudge ↔ cabinet.routes ([acefcd0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/acefcd01e5668f3c3ae2d79ec4fcb0c506660426))
...
* **migrations:** перенумеровать миграцию кампании в 0105 ([79b17f0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/79b17f033d5088ae36b9aea32aae2b83ba1aafb8))
* **migrations:** развести номер миграции гостевых покупок с 0105 ([d4f529b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d4f529b70d624c209b51d37e03150a187e790597))
* **monitoring:** одна ошибка в батче авто-разморозки не валит остальные ([53f4d62](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/53f4d6232558152a633e7065f3c44f8504c3f521))
...
* **notifications:** не отправлять отключённые уведомления пользователям ([22370a8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/22370a804114e9514d28b47ca3b55635e12b07b1))
...
* **oauth:** привязка провайдера тоже возвращается на домен запроса ([d99ab15](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d99ab15c9957d5e24d4ea068e34e8b0a89632cd8))
* **payments:** дренаж фоновой обработки вебхуков при остановке ([531060e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/531060e836fd25a05cfc0423cadf59f6321cd960))
* **payments:** не терять вебхуки платёжек, выключенных на момент старта ([67532db](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/67532dbd50c97fc5f97b450a53a0d0c72eb64bc6))
...
* **platega:** распознавать camelCase-коллбеки рекуррентной СБП-подписки ([4123ee8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4123ee8268dbe24fd5dac330b1d2f9499275aa67))
...
* **promocodes:** код с одним трафиком не сгорает на безлимитной подписке ([7254930](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/72549306956a58aebff84111b8e0a84072675397))
* **promocodes:** трафик доезжает до строки, а начисление возвращает доступ ([0d70155](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0d701557893e0bfd4d0d6f9797b63cfe6008df52))
* **promo:** рассылка брала пул соединений штурмом и падала таймаутом ([c3168f7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c3168f708899941c0e1f4c53a18aac5fa787ee17))
* **reconcile:** grace-период не продлевается бесконечно — истёк → отключаем ([857135a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/857135a203150214f0ce832b397ddc325f0e6924))
...
* **remnawave:** не подставлять None вместо класса ошибки при провале импорта ([775e507](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/775e5075769bc8ff892b8b359a6f03a4f1e12d1d))
...
* **renewal:** зануление цен серверов при продлении из fallback было мёртвым кодом ([4b09774](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4b0977467ad09633ffaf57e967c42c1ea1c48aa2))
* **repair_fallback:** детекция застрявших — только подписки с end_date в будущем ([e074e04](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e074e045310910c0c0e4f42fb7f607aaaf840f1b))
* **repair_fallback:** докстринг, возврат за сервер, новые тесты ([2c7576f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2c7576f785a73f0983c0e06ce6eea8a4ae1b7308))
* **repair_fallback:** компенсация бралась с чужой подписки + падение на naive datetime ([ef79235](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ef79235f79a9b4ad81bd020afb3306c4a170f41c))
...
* **rich:** ссылку на профиль ставим только настоящему Telegram-логину ([accda9a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/accda9aa0a69dc1b2fb34d0c9ab036c722020b7e))
...
* **subscription:** продление всегда снимает триал и подтягивает платный трафик ([a05cfcc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a05cfcc4740198f26a603259d942145fc8fbbc36))
...
* **tickets:** длинные сообщения обрезались и не показывались целиком ([064e067](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/064e0673b86db4195a85ec5eaf5e349e3324fef2))
* **tickets:** длинные сообщения обрезались и не показывались целиком ([3be6da7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3be6da7a8c6c8fc423d110850f1376207c82d2d1))
...
* **tickets:** экранировать превью ответа в уведомлении пользователю ([f898414](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f898414bb4dfca6350d02242088bae44fe7fce8d))
...
* **traffic:** не читать даты периода вне ветки, которая их задаёт ([993ea75](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/993ea75c90ebc769d6fe064c21f8fbf05bfc28d9))
...
* **автопродление:** пропускать продление замороженной подписки ([f012997](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f012997125315b759dace57ba6016937f3618757))
...
* **уведомления:** тексты для SUBSCRIPTION_FROZEN/UNFROZEN — Telegram и email-шаблоны ([d6c40c7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d6c40c7db04dad508229e6f009a741e6f7384c66))
...
* **repair_fallback:** массовое чтение панели вместо per-user вызовов ([11e03cd](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/11e03cd605be19773f6f0fa6480c344e1456eb88))
...
* **campaigns:** вынести привязку к кампании в сервис ([a813083](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a813083c7a2140b1193c1ff10cb4a7809f5e95e3))
...
* **макет:** синхронизация эталона простого режима с решениями ([49c8fd1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/49c8fd1fab792540ad2a4191e8e7c17958afcb0d))
* **макет:** убрать «Изменить трафик и страны» из эталона подписки ([806a360](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/806a3608e567d92342f65133bc18328065479c61))
* **патчноут:** автопокупка после пополнения включена ([7cb4048](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7cb4048c437c4bbe8a67547a2c30ba4d8339fbde))
* план и макет волны 3, патчноут по всем волнам ([65adf9d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/65adf9d8a9cb53ba0f7d9537b4aaa5f6705a175f))
* **план:** реализация заморозки подписки (15 задач) ([7bf3b29](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7bf3b29e34229c6e47e4e02421109d2d1264efa6))
* спека оплаты подписки за другого и подарка по стоимости ([71063e1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/71063e1039bbf96826ff2421e43ce6ef230e8c8c))
* спека простого режима, планы волн 1-2 и черновик патчноута ([c6f62be](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c6f62be1a84f11b77d6ebf824b2cd4452830b638))
* **спека:** дизайн фичи заморозки/приостановки подписки ([cb54e61](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cb54e619639d06d2ad9a5538e922a3b00fcbd2e9))
