...
* **admin:** toggle_modem action для управления модемом пользователя ([3f65833](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3f65833efbe9e4d4fc82a1b86676f3f1f71e86e0))
...
* **ai-support:** добавить настройки ИИ агента (имя, стиль, тест-режим) ([46a1e96](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/46a1e96d7c37331025dbe116664439a8b7f16fc5))
...
* **broadcast:** рассылка только админам для тестирования ([f4bd737](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f4bd7372da2b9f21f32b3a9543247a5eb9849d2e))
...
* **cabinet:** добавить API помощника поддержки ([5336ac5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5336ac52488c97fc487c249eba66f3d70da7c3db))
* **cabinet:** добавить отвязку email в личном кабинете ([3c8bac1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3c8bac1e88fbdcd1541cad81fff4df88a353402e))
* **channels:** отчёт по подписчикам канала с фоновой генерацией и CSV ([829254c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/829254c024ff64050a10663f337fb500e2135f15))
...
* **promocodes:** добавить ограничение промокода по дате регистрации ([7d191f7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7d191f75b7d54ec7593d95f858b337e7b34e8ba2))
...
* **subscriptions:** разрешить несколько подписок на один тариф + скрипт миграции SHM ([26aee69](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/26aee695da7f9da113ff44fd13f4bda3a2764452))
* **subscriptions:** удаление подписки для юзера и админа ([19a7985](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/19a79853633358d3b04a5e9acc9df808629a5ee9))
...
* админский endpoint DELETE подписки (cabinet) ([943e17f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/943e17fa5def7cc4cf76e2b9c2a2fbf3b1fe64b6))
...
* рассылка предупреждения подписчикам не в канале ([973ed95](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/973ed957192e9553a9547f7683e65702ef92a84f))
* списки подписчиков заблокировавших бота и не в канале ([424ce26](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/424ce261158f1bed44544e464683c9009ebf1ce0))
* срок подписки в списке заблокировавших бота ([c75b34c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c75b34c64cc1eb19a2d69fb14eb6ad15758c172e))
* удаление сообщений в тикетах + инфо об устройствах при удалении подписки ([61337e4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/61337e45b4725a041b72bd3f49c22d1105f5d6c4))
* штрафной сквад для заблокировавших бота ([7d50d3d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7d50d3d40f9227e0e4690c8646f075f62f6c6d96))
...
* **admin:** добавить импорт get_subscription_by_user_id в admin_delete_subscription ([41301eb](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/41301eb2229d22664eff7731f9966d484e22174e))
...
* **broadcast:** парсить ADMIN_IDS строку в список int ([c9e2d36](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c9e2d36f68da96507a042f8739a646f87d82b42e))
...
* **cabinet:** добавить modem_enabled в ответ /subscription endpoint ([6e7cd34](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6e7cd34c92799afaf37b34792276d0ebac8f9e61))
* **cabinet:** добавить прокси для Telegram OIDC JWKS запросов ([d00fd9e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d00fd9e04b3e18658cde4adaf07b267b09073112))
* **cabinet:** исправить KeyError subscription и ArgumentError в ORM loader ([ffba903](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ffba903231eab021be4bc69447a48b214919f66f))
...
* **cart:** добавить обработку cart_mode='subscription_purchase' в автопокупку после пополнения ([8acfeb2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8acfeb27155895e013c5c52e3f0c4996fb641e4e))
* **cart:** сохранять корзину в purchase-preview при недостаточном балансе ([adc31c7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/adc31c73f221874bfc1bb6e36d99ff63ddc5bd27))
* **cart:** сохранять корзину при любой ошибке в /purchase (cabinet, classic mode) ([fb15b19](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fb15b19bf4b776f5c6b3c79adc4d0c13ad6fef27))
...
* **channel:** исправить деактивацию RemnaWave для всех подписок вместо только деактивированных ([f02bc81](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f02bc81b8e4ab33f9e8fe4556adfbdfbe5c68bf2))
...
* **locales:** добавить отсутствующие ключи BTN_MY_SUBSCRIPTION и др. во все локали ([fbd3344](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fbd33446dd94a4562a8e562e4f25caf66da1174f))
...
* **migrations:** merge alembic heads 0057 и 9003 ([51c4a52](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/51c4a52b04d53aa5768db9ad942897c8e52ab079))
...
* **migrations:** исправить конфликт голов Alembic после мержа upstream ([e904dfb](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e904dfbbf3623eb06e2e1685177720eae12ae40f))
...
* **partner:** требовать telegram_channel и description, мин. 1 реферал в месяц ([1d9875b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1d9875b8a84ae38387fc5e42dc6b32b6e263c216))
...
* **referrals:** списывать баланс при одобрении заявки на вывод ([fbcb099](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fbcb0999653b478f8463b9a3e4bac048b6aea856))
* **referral:** добавить потеряшек 22-30 марта в скрипт восстановления (11 пользователей) ([070ad20](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/070ad20716928294f9c709a6bdaf622aa43cee55))
* **referral:** исправить импорт в скрипте восстановления потеряшек ([c7ba5a3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c7ba5a312486b53b810a40e23266a5d8642f1ce5))
* **referral:** передавать реф-код через webauth deeplink токен ([888ff5f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/888ff5f389a3c96e828cab1a18c1f74906352610))
* **referral:** сбрасывать has_made_first_topup при добавлении реферера задним числом ([9a0093c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9a0093cd3e93cd90996219e6e5ac4eef7b2a84ad))
...
* **remnawave:** обработать NULL в traffic_used_gb при синке с панелью ([7548e00](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7548e00cbd871348e71b113d4aa6b8bce1526179))
...
* remove non-existent Platega method code 10, rename 11 to Карты (RUB) ([033d0da](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/033d0da5e0033a2310431586a291b529e3ccb89a))
...
* **subscriptions:** показывать active + последние 10 неактивных в "Мои подписки" ([e0d2b69](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e0d2b6904aeb35f4980dbc45caa00d1e710ec64e))
* **subscriptions:** показывать только active подписки в "Мои подписки" ([0d77acd](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0d77acde6833ff9cab785a6ece142a15b9779bfa))
...
* **trial:** всегда использовать is_trial_eligible сквад для платного триала ([3c8bac1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3c8bac1e88fbdcd1541cad81fff4df88a353402e))
...
* **webapi:** использовать create_bot() с поддержкой прокси в /send-message ([2230acd](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2230acdb9db6075c37072279241c07cab1d0b9e9))
...
* **withdrawal:** отклонять заявки с пустыми/пробельными реквизитами ([4393309](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4393309f41d313fb60e2fb59edd93859ea3b1e2c))
* добавить импорт get_all_subscriptions_by_user_id ([2f6d4de](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2f6d4de774b4dd5d6f49cb51731c8a96bfc645d8))
* исправить TypeError для NULL traffic_used_gb и ошибку валидации тега ([daa7575](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/daa75750a960bf4291ede90d7a6e8fd23ff2c0eb))
* исправить несколько багов в продлении подписок и admin-панели ([054f3e0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/054f3e0abf0187792c9c7ac09f7005f7a5f65d94))
* исправление парсинга черного списка (поддержка '#' и извлечение username) ([357d94d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/357d94d1b0d7fc8036b00cbb6b75175c29821751))
* исправление парсинга черного списка (поддержка '#' и извлечение username) ([2f71846](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2f7184627a0fb598a8c0208905cdecf0e4bb04a7))
* каскадное удаление подписок (FK constraints) в боте, кабинете, админке ([239f702](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/239f70272c5f358d4af22c749a016aaab6ef0967))
* разрешить продление classic подписок в режиме тарифов ([9bfa53d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9bfa53da289d47642fe734060000397665905285))
* разрешить удаление active подписок через Cabinet API ([e916ef5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e916ef50b9233147c7863e64c2136a7f47d9824b))
* убрать трейсбеки из warning-логов с явным exc= ([9214efe](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9214efe58c7f860737d8bb899907e76ed8598983))
* устранить MissingGreenlet в автоплатежах и починить traceback в логах ([db79cc9](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/db79cc9eb0d7dc7a4a1ae9190f7a23c6c9e6e317))
* устранить root cause MissingGreenlet в автоплатежах через refetch по id ([3b03c25](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3b03c253cc1603fe54fddcbc8bc374ec2c71bdfc))
