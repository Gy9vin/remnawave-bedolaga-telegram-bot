...
## [3.33.0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/compare/v3.32.2...v3.33.0) (2026-03-15)
...
* add _calculate_servers_price (fixed fallback) and _calculate_traffic_price ([88369ee](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/88369eec5047e733d26d2450a74abd0d600b2e1b))
...
* add CLASSIC_PERIOD_PRICES to config ([c3bb63f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c3bb63ffed6e0b684c322aa51d70ab7e71c8eb6b))
...
* add gifts section to admin user detail API ([bca8bab](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bca8bab4336b2583da9be8c642985e6a0151e33d))
...
* add LIMITED subscription status and preserve extra devices on tariff switch ([8f43452](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8f434525eb14618e3c3e26261d443b1632c111bb))
...
* add promo group and promo offer discounts to gift subscriptions ([2fd0f6a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2fd0f6aa4eb62f704208c1e56a6542d3967e7867))
...
* add RenewalPricing dataclass and PricingEngine discount methods ([83ca51c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/83ca51cd5b040e747c6db904dde0f3a5c59f480f))
...
* add show_in_gift toggle for tariffs in admin panel ([cb5126a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cb5126aff8c15938a59ea9c4f8e605b250b05dbc))
...
* add sync-squads endpoint for bulk updating subscription squads in Remnawave ([b1e2146](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b1e2146254255586b5be9bd894ac4d113a0a8cf5))
...
* **admin-tickets:** поддержка медиа в ответах администратора ([6b69987](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6b699875d29a48933196c39e36c4e27d6eafbc34))
* **ai-support:** добавить GIGACHAT_CLIENT_ID в конфиг и клиент ([abca31a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/abca31a8da55dbc4487377e3e376f76860379fff))
...
* auto-sync squads to Remnawave when admin updates tariff ([076290e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/076290e0c1d81b610a7653d6b64ed218e0f124b4))
* **cabinet:** добавить AI suggest endpoint для тикетов (пользователь и админ) ([99266ac](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/99266ac4a7e20ef87df6df1bdd1f9a860fefd6ed))
...
* **devices:** автосброс HWID при уменьшении device_limit во время покупки ([c356705](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c3567055da448344b8e40178af60b3a2d6d5ae71))
* **devices:** сбрасывать HWID при любом продлении/покупке подписки ([2a540fa](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2a540fa0d1f0921fac4786f2f2f9c6ec607b43fb))
* **devices:** сброс всех HWID при уменьшении лимита + уведомление пользователю ([938ed98](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/938ed98cd12bbd84894639fe808b919eb2a4294a))
* **devices:** уведомлять пользователя о сбросе HWID при продлении ([4fe4e8c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4fe4e8c89baaa0d68656a1e8dd7dfb3610cda8b6))
...
* gift subscription code-only purchase + activation via deep link ([5ffce17](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5ffce175dcb8aebf22cf536bfa032c66da284600))
...
* **happ:** интеграция модуля Happ Management ([6621aa1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6621aa11b6265e7e9b97e2e3aef44c24bc92c28b))
* implement calculate_renewal_price with tariff and classic modes ([02e5401](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/02e5401327786c9dfe5ae7d4c89624c9455aa53e))
...
* prevent self-activation of gift codes ([b30c73c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b30c73c300019646ea4a0d7e1bf758464ee58f0f))
* referral links now point to web cabinet instead of bot ([12ae871](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/12ae871653399bc4ccd23b6394878e814ce9cd75))
...
* 3 bugs — notification type, referral with channel sub, BOT_USERNAME ([3c96c2a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3c96c2affd5a803311e3c0c9a0f844d2217f387a))
* 3 critical issues from second-round review ([a90d2d9](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a90d2d936793daaadf116cf314b736a9ebfb7c3b))
...
* add minimum 8-char length check for gift token in bot deep link ([8a8337f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8a8337f538c3fcaf84b84c34b7a1e38a4ce9d580))
...
* add missing settings import in admin_users tariff switch ([b2ee6c7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b2ee6c766a1fb0c9a701684a6349b970d12f5e2e))
...
* add nested selectinload and referrer eager loading to prevent MissingGreenlet ([3306e02](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3306e029021c396e13774a205225beece4fbbcfb))
...
* add per-category discounts and months multiplier to classic mode ([1660b24](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1660b24f9844374bbd156f9202a8e1550a6beb49))
* add period_days whitelist validation and type annotations ([18e2e78](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/18e2e7841a6d614263e7c87db5964916ec869a9d))
* add post_update=True to User.referrals self-referential relationship ([9957259](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/995725988150f31d193631120a4692e88fa4dd57))
...
* add selectinload to user lock queries to prevent MissingGreenlet ([5442f28](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5442f288d4c6c3973dd92ac141172a9f0e53a28f))
...
* add Telegram Stars payment support for gift subscriptions ([5424d8c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5424d8c31484873b0adc0bc980abdc51ee81325b))
...
* address 6-agent review findings for PricingEngine ([c9f2dff](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c9f2dffabf6369df360c5f9ad7a12c0415026310))
...
* address review findings from 5-agent audit ([08bea70](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/08bea704ded78102dce29deac8da95c4e4b9d815))
* address review findings from 6-agent audit ([5c34656](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5c3465647639d6f07432bc3d725bba9396af6c45))
...
* atomicity refactor, review fixes, and DELETED recovery logging ([ba54819](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ba54819f9cd7f60914dd472b68885683f435db4e))
* **auth:** заменить logging на structlog в cabinet/routes/auth.py — TypeError на kwargs ([4a0a182](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4a0a18259b641dd4c7cfecff672cf2503a0f87bf))
...
* **blacklist:** добавить модель BlacklistException в models.py + миграция 0032 ([122979b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/122979be2c584fd8f14a4a59f5d96d8680bd2215))
* **blacklist:** заменить несуществующие методы сервиса на CRUD; fix(logo): защита от LOGO_PATH=директория ([e821211](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e8212116679797cbe8ba094d5d52cf662e97db1c))
* **blacklist:** исправить get_exceptions_count — вызвать CRUD напрямую вместо несуществующего метода сервиса ([0968659](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0968659d14d488e66e5fc785b1760af492e527c6))
* **blacklist:** проверять исключения из БД перед блокировкой пользователя ([004a874](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/004a8742221bb6f228830431f10867b7ff31ec06))
* **blacklist:** убрать импорт BlacklistException — модель отсутствует в models.py, бот не стартует ([2f97b2b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2f97b2b4f90867a59b11f3f8c18e9b7d02490e04))
...
* **cabinet:** убрать авторизацию с эндпоинта скачивания медиа (img src не шлёт JWT) ([5e2f3db](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5e2f3dbbb6fb65e8df13c965ba24b5259e5627ab))
...
* change None assignment to [] + add "or []" guards at all 5 call sites. ([a5fbd74](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a5fbd7400f828824c5baa520bdaf06023b4caf70))
...
* code-only gifts skip fulfillment in gateway webhook + retry service ([05bcac5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/05bcac502efb1b4298a1c6be91bba5d7c057b9f0))
...
* correct skipped_count in sync-squads circuit breaker and simplify ternary ([8a362db](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8a362db7833b5b7793b5b52345d227cb84cbc39e))
...
* **devices:** min(connected, device_limit) — stale Remnawave данные не завышают минимум ([557f89c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/557f89ceae3bfbc9e9a89c9d8f828202c5f4186d))
* **devices:** безопасный fallback при недоступности Remnawave API ([204ccb6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/204ccb6a4821f286c0c6187d871296c492d3153e))
* **devices:** запретить выбор устройств ниже текущего device_limit в кабинете ([0bd85b3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0bd85b3431871866b338e26b8cea6ed7ceef74cb))
* **devices:** запретить выбор устройств ниже текущего device_limit при покупке ([cefd9a8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cefd9a89a4fec21be7469ac62113f784bec65b0a))
* **devices:** использовать RemnaWaveService вместо RemnaWaveAPI для сброса HWID ([b66c9cc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b66c9cc8ae4a6a7a75d95f3849a445018db2921b))
* **devices:** логировать причину ошибки при запросе устройств из Remnawave ([38c38ae](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/38c38aeebe0941839f51c2d00932c5e1b0608b90))
* **devices:** минимум устройств = реально подключённые в Remnawave ([3df642c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3df642cb0f05ea5f122e72a09ee8ff561040393b))
* **devices:** передать min_devices во все места вызова get_devices_keyboard ([ce0e50a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ce0e50a8ec66c80dd1d9bcab3acc7d8c166027c0))
* **devices:** при ошибке Remnawave API fallback = device_limit, а не DEFAULT ([3be8df9](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3be8df9814b32ee8cec1ba37b7d2ef1aab928f5e))
* **devices:** сброс HWID только при уменьшении лимита, не при увеличении ([4f6ea44](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4f6ea44a8ff55e944750745642690b86b0114e33))
* **devices:** убрать ограничение минимума устройств при продлении ([64d9b8b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/64d9b8b63ebd0196129a8adb5be78e45a34ac226))
* **devices:** убрать постоянное предупреждение об устройствах с экрана выбора ([daf4259](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/daf4259366874a3e22307595f83e8081a1158e17))
* downgrade known-harmless RemnaWave 400s to warning level ([0419781](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/04197817fede058dc4688dce2f9877f0fc2a7f7f))
...
* **freekassa:** вшивать telegram_id в order_id как fk{tgid}_{6 символов} ([5c109d3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5c109d319abed165357fe08c11dd7d2fcf0e1fc7))
...
* guard rollback on commit flag, add flush to promo_offer_log ([b7775b7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b7775b72dc7a1b3d18f179c2f247fe9f47023347))
...
* handle legacy telegram_id in YooKassa webhook recovery metadata ([815a1d9](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/815a1d9136f39b932d4b369aec9d67034d6785d9))
...
* harden remnawave API error handling and YooKassa user cross-validation ([585baaf](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/585baaf63c9f535e5311a32085d0187d8c854001))
* harden YooKassa webhook recovery user lookup ([d35ee58](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d35ee58aa6f3edc6a9e8ab43025569262acf64a2))
...
* invalid ISO date format in node usage stats API call ([69a38da](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/69a38dad259bd05f4658e1014ce0bd73fc2e2ac5))
...
* **logo:** защита от LOGO_PATH=директория в _edit_with_photo ([aad39e8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/aad39e8353f7ae00edb9a0218abf267e12c5801c))
* **logo:** сохранять file_id логотипа на диск — переживает рестарты бота, устраняет повторную загрузку файла ([7c1563e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7c1563e06a35a2584d0d2baaaac1aa3db13d541d))
...
* **migrations:** 0032/0033 полностью идемпотентны — проверка колонок, индексов и FK перед созданием ([b435cf8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b435cf80d48cc539430443757574ee5b8a41fb4f))
* **migrations:** 0033 пропускать индекс если колонка не существует ([511ef31](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/511ef310f8d3458b301bb9f416b1ad5695b9c95a))
...
* **migrations:** добавить 0040 — недостающие колонки users (email_change, oauth, partner_status) ([0c7b37a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0c7b37aaa864d6427bb2bc408c6367227795cfa7))
* **migrations:** добавить 0041 — недостающие платёжные таблицы и partner_applications ([baf74c4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/baf74c4b1cd21b5e57f6544a0fdfca9ea4bb8c2d))
* **migrations:** добавить миграцию 0039 для недостающих колонок и таблиц ([61cb0ce](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/61cb0ceb902d8aa6dc13e50aecbfabb2c660f640))
* **migrations:** переименовать 0035_add_blacklist_exceptions в 0038 для разрешения конфликта с upstream ([431eec3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/431eec3698290b807f2789c6ca1fa89d8e744f03))
* **migrations:** переименовать миграцию 0032→0035 blacklist_exceptions — конфликт с upstream ([9b855e8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9b855e8a313317ab2dd95826f5d7d89137e3ecf7))
...
* **monitoring:** исправить calculate_renewal_price, GuestPurchaseStatus.CANCELLED и member not found в канале ([dbcb1ed](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/dbcb1ed3c14cafa5ae5eee5feb507d3afbe80aff))
* **monitoring:** не удалять неактивных пользователей с ненулевым балансом ([36d8fe8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/36d8fe84f58ea5d045b9e2306ffd8eb1f17a3e8c))
...
* panel sync now updates end_date in both directions ([def594b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/def594bbb55ef45d3df81524bd8841de73a07340))
...
* pass full token to svc_activate instead of truncated prefix ([38c6adf](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/38c6adfdb4d4fc786bf6ca34a5d54025126130c0))
...
* payment providers — lock_user_for_update + commit=False atomicity ([b4ef52c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b4ef52caa4b324eded8e6c6cb715a09ad59140c1))
* **payments:** добавить user_email в метаданные YooKassa для email-пользователей ([431eec3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/431eec3698290b807f2789c6ca1fa89d8e744f03))
...
* platega webhook ID fallback for SBP and card payments ([aa3459b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/aa3459b8463ce0a54b7709aa3547b2337064fa26))
...
* preserve purchased devices when admin changes user tariff ([bf72f24](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bf72f241d81e4432f50a61ec3bb829d18c92955d))
* prevent account takeover via auto_login_token, ensure promo group on all purchase paths ([b3f3eba](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b3f3eba5756404df9ed0f12d8048244ca536f7d3))
* prevent balance loss on auto-purchase for DISABLED subscriptions and fix WATA expiration ([266340a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/266340aad195995f208ed82fc11e0909d34898f4))
...
* pricing audit — display/charge parity, race conditions, balance locks ([ae99358](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ae99358ae9f35a25370ab127d98a0b630a08e3f2))
...
* reactivate subscription after traffic top-up when status is EXPIRED ([8b35428](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8b354280558a5f28d1b99eae55ccd21a4af6a07b))
...
* record transactions for free tariff switches and admin tariff changes ([864a4ed](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/864a4ed7005195ff3be3a8bb2e7666bc5a7f3e4e))
...
* **referral:** игнорировать ошибку удаления уже удалённого сообщения в show_referral_qr ([24d8dc2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/24d8dc2e62daa702cb917772a79edd3d55c36342))
* refresh user subscription after gift activation in /start ([363ccce](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/363ccce56d3e61554ca49d725322a79b05bc65d3))
...
* remove begin_nested that breaks activate_purchase transaction ([0005d59](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0005d59da1e58c38561c8346db89d8475a25d7df))
...
* **renewal:** передавать параметры тарифа при продлении триальной подписки ([1c1c953](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1c1c95319d36f3bc9b1dcd48972bf004610bb28e))
...
* reset subscription for paid users, trial-to-paid tariff conversion, gift purchase MissingGreenlet ([e67b8e4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e67b8e448e5396ee6daa8c6278bb5a0b313dda74))
...
* resolve merge conflict with dev (accept calc_device_limit_on_tariff_switch) ([ba049ca](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ba049ca017e004c25f8738f01b2d5f329a35bb5e))
* resolve MissingGreenlet in switch_tariff endpoint ([4d695be](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4d695be7d51adda40fa72c00c349fb0e1ec4acd2))
...
* **security+bugs:** критические фиксы безопасности и финансовой логики ([423a7d2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/423a7d29331f453232be683423c8f4e67d852277))
...
* silence PARTICIPANT_ID_INVALID error in channel subscription check ([14dceaa](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/14dceaa39ff9faa1c9205483653014a1c5ac73fb))
* stars rate rounding + device/traffic purchase stats ([641ff86](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/641ff86bf6f1ac1f22146f4344beda05759869fc))
...
* support prefix-based gift code lookup for activation ([4fb72ae](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4fb72ae6e3bc65d93ab84b594b4ff5b4856c5357))
...
* update promo group via M2M table so admin changes persist ([68bc8eb](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/68bc8eb57c792059d2be8a8fff6bba3254d3773d))
...
* use keyword args for Path.mkdir in asyncio.to_thread ([2879996](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/287999645506a49b6693a184757598e1cdceb4d8))
...
* user deletion FK error + connected_squads None TypeError ([a5fbd74](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a5fbd7400f828824c5baa520bdaf06023b4caf70))
...
* сообщение об отключении устройств + NameError modem_price_kopeks в renew ([2fc9584](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2fc958439fec22597de7f2e302572d27ff272f17))
...
* add typed breakdowns + module-level singleton to PricingEngine ([b551def](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b551def3402e2bf762406fb0b374360958231bb3))
* deduplicate gift activation in start.py ([769d3a0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/769d3a0b309fb6be1c3175cd66a0df7cb6e2fb67))
* extract shared formatting helpers into app/utils/formatting.py ([5e9a462](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5e9a462261e46ee649de481266a821fd6793bf2e))
...
* make finalize() accept both old and new pricing types ([3efa24b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3efa24bab3a2bd1d31103b134e502c10af8e41e1))
* migrate admin user price calculation to PricingEngine ([49c0f3f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/49c0f3fc10d27092961601cf7f6a780fb56885fa))
* migrate all callers to pricing_engine singleton + fix miniapp discount ([e24b911](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e24b911283bf4cbee7b18d3e49c935217e4a2863))
* migrate bot renewal display to PricingEngine ([ce82c2c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ce82c2c00988542ac73dc9d2e811711ea9cefebe))
* migrate bot renewal execute to PricingEngine ([acf27a1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/acf27a102308d38676b2ccaef78016b56a80935d))
* migrate cabinet renewal display + execute to PricingEngine ([28fc36d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/28fc36dca41b626430baf823274561269023ac59))
* migrate cart auto-purchase to PricingEngine (fresh calc) ([bd2e93a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bd2e93a6a5076341b104f7dba2b7fc5fdb587e66))
* migrate menu.py renewal pricing to PricingEngine ([652b6da](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/652b6dabde014d19075f13198dd06e5fb8bef380))
* migrate miniapp renewal display + execute to PricingEngine ([cb43aca](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cb43acab3194bbf9b6e2c04ca0254ba5b2571b2d))
* migrate recurrent and monitoring services to PricingEngine ([978f68e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/978f68e7be42b0faf92d9ac5bc0bbaa2022ac95b))
* migrate remaining callers to PricingEngine + cleanup dead CRUD ([75dbd2b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/75dbd2b4fcc8ab14ac44d915bf55b10406544bb1))
* migrate try_auto_extend_expired to PricingEngine ([e6ebc67](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e6ebc6722d826d291156e6bff3bf86000b32b783))
...
* remove dead pricing code and fix miniapp classic mode ([c9a9816](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c9a9816daa15a4534a3990822543eeefe1a1631b))
* remove estimated price from balance, simplify server sync, fix HTML injection ([a798f11](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a798f1143eebf52e18254bddd610f7f14a0c4056))
* rename GIFTCODE_ start parameter prefix to GIFT_ ([42b6c80](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/42b6c80a48ad0100d5ddbbe99a096ebb7b292f08))
* **subscription:** убрать блокировку выбора устройств, добавить авто-сброс HWID ([80b087c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/80b087c29c6bd3f721c7c53193e236aacac9f939))
* unify first-purchase discount algorithm with PricingEngine ([fe4e6ac](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fe4e6acb5391d0797ea01281eeb2e2ea59a0070f))
