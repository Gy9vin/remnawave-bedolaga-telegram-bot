...
* **admin/blocked-users:** загнать в штрафной / вернуть по Telegram ID ([a8beab2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a8beab28c0435061fa354ca136c443f62ea722b4))
* **admin/blocked-users:** кнопка «♻️ Вернуть всех из штрафного» ([3bbda55](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3bbda55ccb59468b2967868988975304019661ba))
* **admin/channel-nonsub:** кнопка «Обновить» делает живую проверку через Telegram API ([2b794f6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2b794f66acb0a61b1c8a634f5c23bdb3bbb52ff6))
* **admin/expiry-fallback:** диагностика whitelist в меню бота ([80e5b5b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/80e5b5b7d7b73f57a4fafd17946b1cf996c33cf3))
* **admin/oauth:** вывести OAuth-провайдеры в группу настроек кабинета ([0a5ad53](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0a5ad53af11cfac2a1fb975378caf9cc3dbdd2b6))
* **admin:** link/unlink email + Telegram + merge users из админки ([1677614](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/16776141dd947f4c06a9e1be4485d4cb7753494a))
...
* **admin:** кнопка «Вытащить из fallback» в карточке пользователя ([528475c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/528475cf8cb4756a0e627fd9bed6732bd7588ea2))
* **admin:** кнопки 'Сменить Telegram ID' и 'Передать рефералов' в карточке юзера ([4ad81da](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4ad81daabc08da932de66067ec0ff7e8e34fddee))
* **admin:** показывать внутренний DB ID пользователя в карточках ([66641dd](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/66641ddd18b1bb5cc06ae365423ada76b0dfc280))
...
* **broadcast:** добавить target 'fallback' для рассылки на юзеров в fallback-сквадe ([b02e6ec](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b02e6ec96515d392ecde2707acef24cd24bd2a3a))
* **broadcast:** запрос заблокировавших бота с активной подпиской ([107961e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/107961ea9298e10fcc46c21cc520619d6a7a1f25))
* **broadcast:** колонка blocked_user_ids в broadcast_history (+миграция 0094) ([3392300](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3392300e8234a7e28464beb9629b317e7b7b531a))
* **broadcast:** сохранять telegram_id заблокировавших бота в blocked_user_ids ([5f62c94](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5f62c94e8178bf3ca9a82baf6c11f06faf1e6326))
...
* **client-detect:** parse_client_app из UA-префикса ([f48e1af](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f48e1afce07336548a6c6c8f59f1f5a9fb890c3d))
...
* **expiry-fallback:** API массового перевода expired в fallback ([ba9618c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ba9618c11bd22c9b60d07073d5b676c1ce4c8a85))
* **expiry-fallback:** API удаления старых EXPIRED по балансу=0 ([6517189](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/65171895183fdf675213cf5ebeb69f8371e9694b))
* **expiry-fallback:** кнопка scan-and-move в админ-боте ([1c93c97](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1c93c970d9e08d749afc89ff3be719451a0fca7e))
* **expiry-fallback:** кнопка возврата ошибочно загнанных + auto-clear после покупки ([6e750f4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6e750f4fe6664a5f57a50e915a55dd4488f521c3))
* **expiry-fallback:** сброс трафика при переводе в fallback (reason=expired) ([0ecc703](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0ecc703bbd8036255aec0ed0f4afc2b4f529e4f2))
* **expiry-fallback:** этап 1 — модель, миграция и сервис ([0ebc4ff](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0ebc4fff4295d56e3aba8f71eca443189ea4b4b9))
* **expiry-fallback:** этап 2 — триггеры в monitoring/renewal/webhook ([4ab901a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4ab901ab83530ca7d3181c23da8bea989d9b0541))
* **expiry-fallback:** этап 3 — grace-period подход + periodic reconcile ([4159784](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4159784041b148a105de1b3b34e2180992c2ffed))
* **expiry-fallback:** этап 4 — уведомления админам и юзерам ([28c77fa](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/28c77fa881887ed865e99e3fe8aa4deaa90695da))
* **expiry-fallback:** этап 5а — флаги fallback в API подписки ([c8973bb](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c8973bbab1eabcd2f947d6ec15420666f9a48f26))
* **expiry-fallback:** этап 6 — админ-API статистики и массового возврата ([224c369](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/224c369da544506dc12ab2e1a29c46f63a0a0538))
...
* **fallback:** кнопка 'Вернуть всех DISABLED в fallback (+3 дня)' ([2cf02a0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2cf02a0e3d1dd18c71e5adb8d91b362854d059c7))
...
* **google-migration:** admin-эндпоинты кабинета status/send ([357a154](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/357a15403b90711b45f8d52fd07297d71df44991))
* **google-migration:** CRUD выборки и статистики Google-юзеров ([b066d27](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b066d27fe4b534bca8315f3767b40040835c5dc3))
* **google-migration:** кнопка запуска рассылки в Telegram-админке бота ([c100f91](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c100f91d5148aa95e00ac3f791af091b2b2702ec))
* **google-migration:** настройки и долгоживущий срок токена инвайта ([ddf4295](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ddf4295f212bbdefd7b873a9a3ae427e5d435f38))
* **google-migration:** сервис рассылки инвайтов на задание пароля ([3cc6f8a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3cc6f8a5f2d916a6618481684c35a0dc455dc3b9))
* **google-migration:** список не мигрировавших Google-юзеров ([dc7fe34](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/dc7fe34483ff5ffb5272e13e9c9056fe15149894))
* **google-migration:** счётчик не задавших пароль в меню бота ([ef31c29](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ef31c29341cada395f4cfcd771f7941b70a5dee3))
* **google-migration:** тест-отправка инвайта на один email ([31f018b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/31f018b433399dcf3669f2c414014e7214064b84))
...
* **nodes-restart:** авто-перезагрузка всех нод Remnawave по таймеру/расписанию ([18e14bc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/18e14bc590b15c2c6af19819aea74b5503fdc0f8))
...
* **penalty-squad:** авто-возврат когда юзер снова пишет боту ([4ff81f4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4ff81f4526e256f6fe76167113a46df915eeabc4))
...
* **sales-stats:** доход без ручных пополнений + новые платные подписки ([a18cb55](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a18cb55b4f3722f7576832747a990e6b434559c7))
* **sales-stats:** метрика возвратов в сводке ([fcf1ca0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fcf1ca081304747521542178f1adeae29e5f3b2b))
* **sales-stats:** метрика здоровья оплат (success-rate + неудачные покупки) ([b69021c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b69021c75feca5a18f2df885f9c416732be35d95))
* **scripts:** диагностика причин False + throttle + retry ([19aae1a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/19aae1ac9dcd4479860b9246057f623fe59bc782))
* **scripts:** откат ошибочных restore_external из reconcile-бага ([ca993f7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ca993f7009e309c8a18d22071fbf6a2c09ddd74a))
...
* **wheel:** бесплатные спины и простой режим вероятностей ([e16be17](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e16be17db9f2908d1b1d50aa0417c0aa22ff6e76))
* **wheel:** уведомления админам о бесплатных спинах в отдельный топик ([e659b40](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e659b40633c2f8b369c728cfc67f7404810949cc))
...
* Поддержка кастомных Telegram Premium Emoji в кнопках для Menu Layout (Bot API 9.4+) ([7c8f207](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7c8f207abb789918bba30537dfe160f412b60760))
...
* **account-linking:** merge bugs 1+2+3+5 — устранить старый endpoint, OTP UX, rate-limit race ([0dd9f42](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0dd9f422a499db285aee4b436fdab56cba6512ae))
...
* **account-merge:** не падать на общем реферере и не терять юзера в панели ([3de2a78](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3de2a788d96df3093be0f70a88d1e1d785594a62))
...
* **admin/oauth:** корректный redirect URI в подсказках ([236682d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/236682db416fbf74e5b9f48c0c406db440f93132))
...
* **admin:** блокировка/отключение в кабинете теперь действительно отключает в Remnawave ([92e74c6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/92e74c68da806bda57ce2baa330d777a8372a674))
...
* **bot:** admin_delete_subscription → delete_user_subscription в register_handlers ([1796b72](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1796b72ba1af48be3467f543a910cd9f9f80f310))
...
* **bot:** автоматически удалять webhook при старте polling ([6a912da](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6a912da19457945a3e43cbf39dbe740a09edcac2))
* **broadcast:** await async get_updated_message_buttons_selector_keyboard_with_media (3 хендлера) ([313ad01](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/313ad01a2bdfde06ecedfe0b01d0a13d4abab43d))
* **broadcast:** endpoint возвращает recorded — различать 'нет активных' и 'не сохранено' ([22212bc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/22212bc2e9ba3cf384f7a56a5f54a97d6a30e5d6))
* **broadcast:** не падать на URL-кнопках канала/кабинета и убрать ошибочный await ([08138bc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/08138bc27a88cc674234f6cf3be80fac73b9589e))
...
* **cabinet-mode:** Главное меню кнопка теперь всегда возвращает в bot-меню ([0f5873a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0f5873a2a025709fe2dec4f2049fe80e4627ec97))
...
* **cabinet:** CABINET_JWT_SECRET требуется только если кабинет включён ([cf89292](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cf892922ca8e8073959e670b7a2fb4c7fb213bbc))
...
* **cabinet:** админ-уведомления → asyncio.create_task (не блокируют HTTP-ответ) ([b3003b2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b3003b26ae8aec9a69c39a63e4fd85b00ecc76e2))
...
* **classic-purchase:** обнулять tariff_id в SubscriptionPurchaseService.submit_purchase ([17e620b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/17e620b3af7722ded531067455e3c61bff6749c1))
...
* **contest-service:** транзиентные таймауты БД — warning, не error ([b5a2644](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b5a264484c45d07f1690ef6b6f1b5973014dd246))
...
* **cryptobot:** защитить JSON-каст payload от не-JSON balance-строк ([5758f59](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5758f59445e27e7ffb80a11c78885f206ce733d8))
...
* device_limit не понижать в Remnawave для тех, кто докупил + rollback в guest_purchase phases ([6b65899](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6b65899378ba3dc7117c6ebb8d0e221445070010))
...
* **devices:** прорейт докупки устройств по остатку подписки, без потолка в 1 месяц ([66ca65c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/66ca65cb6ca328b6e9af928d520a3f5f45081423))
...
* **email:** throttle отправки + retry на rate-limit Yandex SMTP ([7ff87ae](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7ff87ae79fd77176d6a9d08887920e53eb915dff))
...
* **expiry-fallback:** notify=False во всех reconcile-вызовах ([6590e62](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6590e6204bb995519db145fb88b85b3dee969ffa))
* **expiry-fallback:** reconcile path 2 уважает админ-вмешательство в панели ([d1c76ae](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d1c76ae53a15f859014fb2082bba4a5d3b04cd1a))
* **expiry-fallback:** reconcile уважает end_date в БД, а не только панель ([01d03ac](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/01d03ac074c532db9ddbd07bea61b2e362358522))
* **expiry-fallback:** scan_and_restore_active работает на user-level ([480e1ce](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/480e1ce92ea2048b51368c66c20fb8af82be7270))
* **expiry-fallback:** починить connection pool exhaustion при scan ([b12216a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b12216a84297c3cabd2da2682a58a4f8b8911f65))
* **expiry-fallback:** срочно — reconcile ошибочно вытаскивал из fallback ([800931b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/800931b5554f89cd6faf343f99a375f35fc0e983))
...
* **gift:** не сбрасывать device_limit/squads при активации подарка на активную подписку ([cd08289](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cd08289b856ae0f13e8308bba5f567114351589b))
* **gift:** очищать HWID-устройства при активации подарка ([a70ab67](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a70ab67a63b928191bb954edec675889e9267882))
...
* **google-migration:** слать только active + показывать логин(email) в письме ([1418bb7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1418bb77bc31ab6cc97f29528b9c9fa1718cd61e))
...
* **guest-payment:** подарок/гость через шлюз с под-методом (rollypay_sbp и др.) ([837e9e6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/837e9e65a520bfd864ac13a35f7c3d76cb2fe888))
...
* **landing:** суточные тарифы на лендингах показывали цену 0 и не покупались ([b795583](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b795583c7963e7b6b640638af91067616b389bb2))
...
* **logging:** убрать шум из ERROR-логов и админ-уведомлений ([aa01e2c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/aa01e2cb883903631a5e7adeae0c8724e20c049e))
...
* **migrations:** merge alembic heads 9013 + 0082 после мержа upstream v3.55.0 ([09d8b82](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/09d8b82f91d423f4ad81fab0efaec6ec5a32dd42))
* **migrations:** merge alembic heads 9014 + 0085 после upstream v3.56.0 ([657783c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/657783cfa82c6e665067b7d86430b44393abbddb))
* **migrations:** merge alembic heads 9015 + 0087 после upstream v3.57.0 ([2eea92a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2eea92a4ef6861019c5e8efec6da1b5e92f16b8d))
* **migrations:** merge alembic heads 9016 + 0089 после upstream v3.60.0 ([5bcc73f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5bcc73fa22af75464e78054ef09aac2ef226c494))
* **migrations:** расширить страховку колонок при orphan-stamp head ([cd15d8e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cd15d8eaae0476757cb53a803d0abbc46f933db8))
* **migration:** прицепить blocked_user_ids к head 9020 (ревизия 9021) ([96d4508](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/96d45081e1cff0b7f842d5e598785f4ff7f5b67a))
* **modem:** после выключения фичи дать возможность ОТКЛЮЧИТЬ модем ([ed59540](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ed595401da48a25432cd0dacaafd8611dd9b1e60))
...
* **penalty-squad:** users.pre_penalty_squads → JSONB (json type ломал DISTINCT) ([309c6b3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/309c6b3d8cbc75bec7c1f0718e41f7b5bd7780f5))
* **penalty-squad:** верифицировать что сквад реально применился ([4835a50](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4835a5089204850b59d800545607c02f7f6a409a))
* **penalty-squad:** использовать activeInternalSquads вместо externalSquadUuid ([7429ce2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7429ce267c9a30363bfc32894527084ffaca2a12))
...
* **pricing:** корректный расчёт автопродления при включённом модеме ([3acfa5a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3acfa5a238c1ea56402158d09eec5216a0f8e5a9))
...
* **promo-offers:** рассылать промо-офферы и email-only юзерам ([3ba7a68](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3ba7a68f4bb86a4d8fc9c7101041741c34aed90b))
...
* **reconcile-cleanup:** идемпотентность для уже-DISABLED юзеров в Remnawave ([ca9fd71](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ca9fd7109ebc085da5f4b3926c333ebbb0c87738))
...
* **regrace:** ловить и EXPIRED тоже (не только DISABLED) ([78b5554](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/78b5554c7bbca7647d478a2e097b6ef7c64ed033))
* **remnawave-api:** не спамить админ-чат транзиентными таймаутами панели ([cd6902c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cd6902c6f6040695c4dd69171e9b9f6f3af18acb))
* **remnawave-api:** не сыпать 404 «not found» в админ-чат (понизить до warning) ([ed9d4e1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ed9d4e13753233c9bf6cab9a153bca1ab3b36c3b))
* **remnawave-sync:** пересоздавать панель-юзера и по коду A063, не только A018 ([05c7517](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/05c7517a41d258641aa4f32c61dbd17a08abd01b))
...
* **remnawave:** не спамить error-логом для 404 «user not found» ([f0b8087](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f0b8087df03b7fb9fa3d1273a5ce94c7e2d3208b))
...
* **sales-stats:** возвраты — только реальные, не внутренние откаты ([cec8e27](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cec8e271810e167d695452965576f668f498d97e))
* **sales-stats:** корректный средний чек в продажах ([0645565](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/06455657900676fab9cfa4f0cc43743e4335ab63))
* **sales-stats:** продления больше не считают докупки трафика/устройств ([bc36187](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bc361874f50f0530b5ea263a84d392040dc07dd4))
* **sales-stats:** считать выручку с подарков, оплаченных через шлюз ([fafb966](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fafb966b31cf6f95ed42375e5e290da8bb0db893))
* **security+perf:** убрать дублирующий monitoring loop + 4 утечки секретов ([072543c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/072543cc2c4957c7229dfd7c8b4c6974b4ab1225))
...
* **stars:** default rate 1.3 → 1.0 ₽/⭐ to match Telegram cash-out ([1f32fed](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1f32fed03dfce89f3df33e282d059fb8f2f850dd))
...
* **stats:** учитывать ВСЕ платёжные шлюзы в доходе (Jupiter/Donut/Lava пропадали) ([d30b821](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d30b821c970ab3127e3df1fc44dc873fdfcdcd07))
...
* **subscriptions:** дедуп без удаления панель-юзеров (защита от A063 404) ([fb1d72f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fb1d72f72cfb24e6490c6d6ff2f9559f87ee6ccf))
* **subscriptions:** реанимировать истёкший тариф при повторной покупке вместо дубля ([2831982](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2831982a320e9970beee47f541790df6c06db794))
* **subscriptions:** чистить дубли через сервис (БД + панель), не DB-only миграцией ([45189b2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/45189b2bd40a0fb72b03b5df2fa6b06855c84b14))
...
* **tariffs:** update_tariff принимает trial_duration_days ([51a2e11](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/51a2e11c6eb508db0c34293041b74e2aed4dbc83))
* **tariffs:** не показывать trial-only тарифы в списке покупки ([c7d5544](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c7d5544a96d6ad6f5ad13c86ab84790e50ad34a6))
* **telegram-transient:** не спамить админ-чат транзиентными TG ошибками ([1918927](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/19189274046bc208c74ece77210848f727d822e7))
...
* **transient:** retry 5xx от RemnaWave + fresh session для fallback reconcile ([a257ee1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a257ee152dacf952384b6c272bfee9458f2c9c36))
* **trial-button:** не врать про 'бесплатно' когда триал платный ([7934e34](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7934e34c93dae0c1eff886c4aec231a62768c430))
* **trial-conversion:** classic mode — не привязывать тариф к подписке ([e4f2ca9](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e4f2ca9dea63ae900dc5731e59af3281d8f7c428))
* **trial-conversion:** обнулять tariff_id при конверсии trial→paid в classic mode ([626ada3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/626ada3e34781e641f637b921d7bb6f58ed73ccc))
...
* **trial:** 0 ГБ на триал-тарифе = безлимит, не подмена конфигом ([1713452](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/17134523dd7d4917fb8de4bd2d4a43e7d7de1d29))
...
* **trial:** fallback на .env когда у trial-тарифа лимиты = 0 ([2b41a6f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2b41a6f29ff3e660e075bc504fff90f1e9880df0))
...
* **trial:** кабинет не должен отбраковывать неактивный триал-тариф ([e197857](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e197857063e0f9051822288a3f900252e2fed9e5))
...
* **webapi:** /send-message — не спамить error-логом для blocked/deactivated юзеров ([5debafd](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5debafd13fd5a52a864f9cb64d0d7f0ea3b5b88b))
...
* **webhook:** не понижать EXPIRED → DISABLED в user.disabled handler ([ec235bc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ec235bc4f4adff1b6ecc3401abf68d21946eef25))
...
* **yookassa:** идемпотентное создание платежа, без ложного «FK violation» спама ([ca8b9c8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ca8b9c84d87f864337d5c746646d0071b9217474))
...
* **plan:** использовать существующее право broadcasts:send вместо broadcasts:write ([05a797b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/05a797b39360223e96b163ef3e45bbd1f5b7e37c))
* **plan:** план реализации миграции Google-юзеров ([2cf3b59](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2cf3b59272b3aaa256eea49a9ecbb554d95e3209))
* **plan:** фича — заблокировавшие бота с активной подпиской по рассылкам ([b8ded20](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b8ded20203e8ba643d090182af77061e4412c12a))
* **readme:** убрать партнёрство с WATA, шлюз оставить ([f3a215b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f3a215bb9066bae3b8c840d8750f21500eef47b1))
...
* **spec:** дизайн миграции Google-юзеров перед отключением входа ([d5210df](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d5210dfd74b48f6d401341fc2d7923458c752024))
