...
* **admin-api:** эндпоинт POST /set-main для выбора главного канала ([c8ee92c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c8ee92c63e88b4e6ea82a6ca3a78c64f1831e883))
...
* **admin:** rich-вид сообщений админ-чата — уведомления, логи, статистика, старт ([3dbdc8e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3dbdc8e06d5124ce47bedd52eab73bf56a57629b))
...
* **auth:** хелпер needs_backup_login для проверки числа методов входа ([7869ee1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7869ee15e92b667329f8aa6b1eca10bae108979c))
...
* **bot:** nudge-сообщение о резервном входе после оплаты подписки ([b1f6b4b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b1f6b4b022993f20af715cdfa360b23cdff3cfe4))
* **bot:** подсказка про права на каталоги в креш-репорте (PermissionError) ([01db943](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/01db9435c1e68941c64e6f1d8ab77244df75741f))
...
* **broadcasts:** поддержать icon_custom_emoji_id у кастомных кнопок рассылки ([ff029c7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ff029c7073b5a72885e2e53283bb088995072057))
* **broadcasts:** поддержать icon_custom_emoji_id у кастомных кнопок рассылки ([c690351](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c69035111c90b44fc25baf06561bebf9976c97df))
...
* **cabinet-api:** эндпоинты /cabinet/channel-nudge для нуджа подписки/поста ([aea5c61](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/aea5c616ab9bb5aad77124872dd6e879c60607f4))
...
* **cabinet:** admin-эндпоинт истории подписки юзера ([eed5985](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/eed5985df2ab170b5ce9a198294336094d9de55e))
...
* **cabinet:** команды бота (/start и др.) в логе действий пользователя ([fd3efd7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fd3efd714d57a62be174e674cb58c6d9fe8ad225))
* **cabinet:** нажатия кнопок бота и действия в кабинете в таймлайне активности ([2ceb615](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2ceb615a3db763ac2422d6ef9fdf05341eba3592))
* **cabinet:** отдавать флаг SUBSCRIPTION_REVOKE_ENABLED фронту ([70a3ff4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/70a3ff4b2ff463b955112eda99be07cab32bc5b7))
* **cabinet:** отправка прямого сообщения юзеру из карточки в кабинете ([c4130c1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c4130c18a6942c17127c6003a61e5ab83cbeb2b3))
* **cabinet:** панельная идентичность и контракты под 3.0.0 ([2b97440](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2b9744049dcfce6677e44442490202f08b31b0a9))
* **cabinet:** согласие с офертой и политикой при первой авторизации ([3b0306f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3b0306fae60ac2ad905d6c10c35402167d983902))
* **cabinet:** таймлайн активности пользователя в карточке юзера ([be1f67a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/be1f67adc01d77a06782097f14f8f3f46508fe7b))
* **cabinet:** эндпоинт /cabinet/subscription/timeline (история юзера) ([c30b4d0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c30b4d0795b44f0d38ff5006712390dfe85e8fcd))
* **channel-post:** хендлер channel_post для главного канала, обновляет last_post_* ([b6ff85a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b6ff85a94779131c5a038dbe394cf04e2bbbeac5))
* **channels:** персональные исключения из обязательной подписки на канал ([e93c244](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e93c24481e53d657c8406f711c80cb6c50bdc80f))
* **channel:** мягкая обязательная подписка + пуш свежего поста ([619451c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/619451c55cfc54ca76deaecca991723b50126d91))
...
* **client-v3:** единый путь пользователя и двойной парсер v2/v3 ([d15de01](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d15de013acebe5c0004a17e7e94ba0302443a19d))
* **client:** T4 — lookup через stream + resolve_user_id для v3 ([ece5a6b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ece5a6b257aecf749830a41c3cf9ccb0e1b2c756))
* **config+api:** добавить авто-определение версии панели RemnaWave ([b388e8d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b388e8d749c914d0cd9ad83275825967793fdb6d))
* **config:** TRAFFIC_EXCLUDED_USER_UUIDS переименован в _USER_IDS ([88a92f7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/88a92f794267f599bba993811119cccba72fb2f7))
* **coupons:** cabinet API для купонов — партии, экспорт ссылок, погашение ([605c024](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/605c024bc43728420ac2ab970f6389be1ca2bf91))
* **coupons:** лимит активаций на пользователя и удаление партий ([8260944](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/82609441ae29e24d9037ce77b8299836a6ec8844))
* **coupons:** партии одноразовых купонов на подписку для оптовой продажи ([8a5cfaf](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8a5cfaf15a7d62b40791e61cf09e68b1bb3a43ec))
...
* **db:** добавить User.remnawave_id для поддержки RemnaWave v3 ([74d6f18](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/74d6f18875fd66bb03c96a67d0c568cecdbb4926))
* **db:** числовая панельная идентичность remnawave_id ([898bcf4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/898bcf49bcb829e54a02808c0af1055216d81837))
* **devices:** запрет уменьшать лимит устройств ниже включённого в тариф ([8aafb64](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8aafb648b97830aabf885eda47954f92fe888a6f))
...
* **grace:** миграция grace_access_runtime.py на v2/v3-совместимые вызовы API ([713c9c1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/713c9c16f94bb15373d8a8ddc477c3009d2fd041))
* **grace:** упростить квоту трафика и правила доступности ([2e40235](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2e40235e60677550ca975904c381414d2ae8a4d0))
* **handlers:** T6f — миграция обработчиков на get_panel_user_ref и Subscription-объект для v3 ([4a90a91](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4a90a91d06b55987e2b963aeedfd9fe3c2d03cfb))
* **infra:** Valkey 9 вместо Redis 7 для кэша и очередей ([b0709ea](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b0709ea0d5ee4a1097c2757cee59ea1e70a73ddb))
* **kassa-ai:** вынести базовый URL API в env KASSA_AI_API_URL ([b1ec750](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b1ec7506b7fa30f9eeef3c3f8ddf8f686c2cd5eb))
* **l10n:** локализовать флоу покупки/продления/смены тарифа ([0951c70](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0951c708ae7168e9802a22a7a7954f566865ffc9))
* **lava:** кабинет-эндпоинты автопродления Lava ([0dea218](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0dea218298be16111e61572d9d450154e3f476a3))
* **lava:** паритет покупки привязкой, уведомления, сверка суммы ([de3518b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/de3518b763fb1a49d38629472969115a18014134))
* **lava:** рекуррентные подписки Lava по образцу Platega ([9d1772b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9d1772bcfe26a3ef75bb8a47e7e33180d1fa3cba))
* **menu:** rich-главное меню на Bot API 10.1 с фоллбеком на классику ([20c129e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/20c129ea7e55e13555e4d1aa28a8f0825f1c303f))
* **menu:** rich-меню v2 — продление из кабинета, расход, логотип, эффект 🎉 ([242ed40](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/242ed405f22d9d5b9771baef5ac3aeb4c37c036d))
* **menu:** rich-меню v3 — кнопки «Подключить» и «Активировать триал» в таблице ([734773f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/734773f3921620a2ebd1ffab76cfb92d2bdbe30b))
* **menu:** кнопка «Меню» Telegram открывает веб-кабинет (WebApp) ([c7e2087](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c7e208750efd6a2cb43c6c6607cf84d3109f595c))
* **menu:** сворачиваемый блок подписок в rich-меню при нескольких подписках ([cfdce75](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cfdce75865ecfdc35c5a939b240cdf4aa05abc4c))
...
* **merge:** админ-объединение аккаунтов с сохранением ссылки подписки ([f192fb6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f192fb6962b0c7c8c5d29a3d49da357071bf0ecc))
* **model:** добавить is_main и last_post_* в RequiredChannel, last_seen_channel_post_id в User ([35500fb](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/35500fb60b715dbf565418ade6012070ac9a1f22))
* **nalogo:** доставка чека на почту, когда Telegram недоступен ([3c047ed](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3c047edb0b884f6bf5ade8e9bb3bc9c1af382609))
* **nalogo:** доставка чека файлом — lknpd недоступен клиентам через VPN ([cbccaaf](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cbccaaf7ac225d3ba597da1d023da994c6fb00a2))
* **nalogo:** имя и почта копируются по тапу + HTML-экранирование ([078493a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/078493a9ba7440b404a55010aef20c8b5418f64d))
* **nalogo:** отправка чека пользователю + дублирование в админ-топик ([3229b5a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3229b5aaaecf8cda875a20fafdc1cb1d393d33ba))
* **nalogo:** подробный блок получателя в админ-уведомлении о чеке ([0490ffb](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0490ffbed7354c6bb8e1f26d9b6c25565e94caea))
* **nalogo:** порядок полей в блоке получателя (ID, имя, username, почта) ([2ef6963](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2ef6963a70b266714440cd76749e7d757126b92b))
* **nudge-card:** карточка свежего поста в боте после прохождения гейта подписки ([1095639](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1095639fbc9279e07ec85118f09c4942262db812))
* **payments:** интеграция платёжной системы cisPay ([392722f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/392722f9bf69c459844ea0c2bf4075026f8e2bbb))
* **payments:** флаг YOOKASSA_SKIP_IP_CHECK с fail-closed проверкой платежа через API ([2ac5299](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2ac52992f04a004dc61227b14171935243f31963))
...
* **platega:** CRUD рекуррентных подписок ([9cf2aa3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9cf2aa3a546e639369077dfb30ab65bbcb2e5c89))
* **platega:** WS-события sbp_recurring.* для кабинета ([f34431a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f34431a46b00dc2fc1169f9ede4a43aee6405ac9))
* **platega:** админка кабинета — статус и отмена СБП-автооплаты ([135771e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/135771e02e05761b72961a97d7364e72b6706177))
* **platega:** бот-флоу автопродления через СБП ([a69d233](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a69d233886874883b25b89f6d3230db41a3b61f4))
* **platega:** ветка подписочных коллбеков в /platega-webhook ([9d13c4e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9d13c4ec5069e5571212ad967028d8ccaf29e998))
* **platega:** гейт PLATEGA_RECURRENT_ENABLED ([23ba645](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/23ba6455fd43c69075fa8540b0f86f0358c7ac3b))
* **platega:** кабинетные эндпоинты СБП-автопродления (юзер) ([19862a2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/19862a298e6233587de9351abf862f3040dfae6e))
* **platega:** методы подписок в PlategaService (create/get/list/cancel) ([27c8fac](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/27c8fac35a5e2edf88db0723520cc2323cd0118d))
* **platega:** модель platega_subscriptions + миграция ([5c9580a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5c9580a8e0b2ce06199419bae93b648a182a7187))
* **platega:** обработчик коллбеков подписки (продление, идемпотентность, статусы) ([5a33a9e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5a33a9e703137240aa3fc75173840bc861420ad8))
* **platega:** отмена СБП-автооплаты при удалении/отзыве подписки ([2593424](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2593424901a1653a7ea264eff43475bfea6e9694))
* **platega:** отмена СБП-подписки + best-effort хелпер по подписке ([4763cbe](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4763cbe1da6e8d41a15f4880ff36efa436246219))
* **platega:** реконсилятор СБП-подписок в monitoring-цикле ([1cf5212](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1cf5212e085b0267179b3663366e4eab7f9761f0))
* **platega:** СБП-оформление подписки — альтернатива оплате с баланса ([43d81c8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/43d81c86c3d2afe7695af18ad72d072e13229393))
* **platega:** создание СБП-подписки + выключение balance-autopay ([e701cad](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e701cad459a1a3204a5546d829c3b5accb0d1b8f))
* **platega:** чистая логика каденса рекуррентных СБП-подписок ([8200847](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8200847d86de32989df5490a4581a1fffd7c8029))
...
* **promo-offers:** доставка промопредложений на email для юзеров без Telegram ([8913546](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8913546c3d7c634a35c4889214c175550374ab3d))
* **promo-offers:** охват сегментов и прогресс доставки промопредложений ([5e4548b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5e4548b3d3dcee63db42f9b6a57a8daea274a290))
* **promocodes:** комбинированные промокоды — баланс и дни подписки одним кодом ([d8f4b54](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d8f4b545879e3761f5c37d523c19f7021f58875b))
* **quick-amounts:** возможность отключить кнопки быстрых сумм пополнения ([b1f9be6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b1f9be6da15a25c95de1a4f729a1e8f9b844a93c))
* **remnawave:** бэкфил панельной идентичности ([b97e5f6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b97e5f6bbfa7bf792b06f4ac181e214cec5da96c))
* **remnawave:** клиент API под 3.0.0 ([c763514](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c763514324c45aff3193631cc4c344873c3ebc55))
* **remnawave:** локальная генерация happ crypt4 ссылок ([d9042c2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d9042c294256a6454f248e22f86acc5ea3e4b3b5))
* **remnawave:** локальная генерация happ crypt4 ссылок (без внешнего API) ([2ad0d57](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2ad0d575552bf9cc0d9541857d9b9c9ba74f9652))
* **remnawave:** сервисный слой на числовую идентичность ([6da10bc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6da10bcc94e2dbf37e7d646d48e3a3a018a60c4d))
* **remnawave:** транслитерация кириллицы в username пользователя ([35383c2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/35383c206aa0d2bb8e86c3745a96ed8f80666e4a)), closes [#1659](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/1659)
* **remnawave:** хендлеры, миддлвари и Web API под 3.0.0 ([c897d38](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c897d383ceb0177babc5f38ecca368899228bc0d))
* **scripts:** точечная починка подписок без аккаунта в панели ([1bca059](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1bca059b3c9951205c8ee3cefaec89f606627822))
* **services:** T5 — миграция call-sites на двойной идентификатор v2/v3 ([d3044e4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d3044e43b4a61373fb97640cc6999051fa2bcf7f))
* **soft-mode:** CHANNEL_SOFT_MODE=True — гейт остаётся, VPN никогда не отключается ([33f4b74](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/33f4b74839223d63c4431cdf87dd5732b7029f47))
* **start:** видео в стартовом меню бота, загрузка из кабинета ([524960c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/524960c3561953df2f18108b224dfef5292ff811))
* **subscription:** CRUD хронологии покупок/продлений из subscription_events ([319f6c7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/319f6c772e51fe6dd66f80678737050750668107))
...
* **tariff:** прямая оплата тарифа без отдельного шага пополнения баланса ([a060575](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a06057504de86285273e801bc411879b964a4a36))
* **trial-autopurchase:** автопокупка триала после пополнения баланса ([f1edc13](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f1edc1370ea96c5d27abbad529705f7884c7362f))
* **trial:** сохранять корзину trial_purchase и возвращать 402 при нехватке баланса ([e6915d7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e6915d71d13bca68c7bc853bba4d4e205d333275))
...
* **v3-compat:** T6b — миграция call-sites expiry_fallback и penalty_squad на двойной идентификатор v2/v3 ([03341ea](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/03341eaeb25b457171104d77e49bd3fd51ccf27b))
* **v3-compat:** T6g — миграция identity-вызовов панели на get_panel_user_ref ([dbabf98](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/dbabf9805206cb180f1f1af57affb38746ed3246))
* **v3-compat:** закрыть все оставшиеся v3 call-site'ы (T6-hard) и external-squad заголовки (T7) ([8e8460a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8e8460a12af7a20ef2b20d8f358b4ee58e8c1474))
* **v3-compat:** мигрировать identity-вызовы в remnawave_service и subscription_service на get_panel_user_ref ([234d120](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/234d120b6afe6ecb9683e3aaf2dfb7361a0363c5))
* **v3-compat:** мигрировать вызовы API пользователя на get_panel_user_ref (T6c) ([75ac4d9](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/75ac4d952826cda3936cec89d8dda5646a9aaff8))
* **webapi:** эндпоинт ручного пополнения баланса с идемпотентностью ([cd9811c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cd9811c18f679047a30c6c304ca99ab89f386cc6))
* WEBHOOK_SUB_EXPIRING + переводы zh/ua для webhook-писем + тесты ([38771d3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/38771d3e9fdb727aa5b5a5b25e09ae4ce655fd4e))
* zh/ua для winback-писем, честный PAYMENT_RECEIVED для автосписания, тесты ([a37fad2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a37fad271a411e685e66f703dd33c5a987ed0008))
...
* **admin-merge:** logger.warning для no-op keep_subscription_id, убрать id из ошибок клиента, assert_not_called в тесте ([1579ec4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1579ec445b69fe37d84ca9263801bae88c27dcb2))
* **admin:** device_limit = 0 в админке тоже показывать безлимитом ([8e1b2cc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8e1b2cc9af70f3475466d6e8ed4a8c846b2ebdfb))
...
* **admin:** в карточке пользователя не показывались устройства из панели ([f988a96](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f988a96f8b5d8d75b9c5f1f15dd565cf92771cc5))
* **admin:** лог при пропуске синка панели у подписки без UUID ([3d77bc2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3d77bc20a621702ec2f0f3bd4f21a1f5a4a80a9e))
* **admin:** не разрывать &lt;pre&gt;-блоки при конвертации уведомлений в rich ([bf00eda](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bf00eda41f1539e21331d9d3568a64f42902b5c4))
* **admin:** отмена рекуррента Lava при сбросе выбранной подписки ([2f2006a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2f2006a5d08289ccfb3c606d0cdb702ccd369ea7))
* **admin:** переносы строк в rich-уведомлениях + админ-уведомление о триале из диплинка ([53eda3e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/53eda3e8eb3bc5b6b922beed711c34e42ba16b3a))
* **admin:** платёжные провайдеры в разделе «Платежные системы» ([a53f9ad](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a53f9ad2bc13f761a51a43b36bab5ffb5356781a))
* **admin:** рассылка промопредложения падала на отчёте, хотя сама проходила ([f2fe8a5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f2fe8a5b5173d9c0a1af3c162a6a4aa618394e54))
* **admin:** честное сообщение при сохранении настройки, прибитой переменной окружения ([f9dc3d4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f9dc3d4c243a8c9a68773fe08c4f634b50fa3e91))
* **admin:** честное сообщение при сохранении настройки, прибитой переменной окружения ([f63bee0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f63bee0d814f7dde9538e1d56e8600c5fb1687b3))
...
* **backup:** одиночный scheduler-цикл и BACKUP_TIME в локальной таймзоне ([#3030](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3030)) ([e2bad81](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e2bad816300035a970d8ef211c1b49556e6b1efd))
* **backup:** одиночный scheduler-цикл и BACKUP_TIME в локальной таймзоне ([#3030](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3030)) ([b4ad4e6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b4ad4e602cdf082011625abdf6f39f62c34dd184))
* **bot:** падение «there is no text in the message to edit» при двойном клике ([bc36784](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bc36784d29b7288f4ba1badc5260c7b06ad41520))
* **bot:** тексты длиннее лимита Telegram роняли показ правил и политики ([197e096](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/197e09697e02f395fdee8d84f64a22b48b8443c7))
...
* **cabinet-api:** типизировать latest_post как ChannelPostInfo для OpenAPI ([70fe205](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/70fe2050b234a7f5df78c35396a1a472384c5846))
...
* **cabinet:** multi_tariff delete_remnawave_user принимает объект Subscription ([5bea408](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5bea4088b85c3c94c90fd4cefe9ca9d7a487091b))
...
* **cabinet:** возврат средств при сбое покупки тарифа после списания баланса ([#3031](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3031)) ([12f6e35](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/12f6e356a06d43829e7f1cf8e566438406590c1e))
* **cabinet:** возврат средств при сбое покупки тарифа после списания баланса ([#3031](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3031)) ([c5ac200](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c5ac200c1697af7916e72ae3bbef047f7195ae0a))
* **cabinet:** вход через Telegram ломался, когда ключи Telegram не скачивались ([177c0e4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/177c0e4bd46468bbeaeb10438010444dd47da5c6))
* **cabinet:** картинки в тикетах не отображались — inline решался по расширению ([e04611c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e04611c4bdd3f44d556aee296c378bfa81a230e8))
* **cabinet:** критический импорт get_panel_user_ref + v2-fallback-эквивалентность ([76158ec](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/76158ecdb3b09bea056316b8c970eef33ca070f6))
* **cabinet:** отключённую подписку нельзя было продлить ([a66c5f0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a66c5f0a9f86b6ca5c5daa9a15077bdbd8dc733d))
* **cabinet:** проверка каналов роняла вход при таймауте БД ([5d2efce](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5d2efce18dd1e99def85feca7c304a8c66a109dc))
* **cabinet:** публичные branding-эндпоинты падали 500 вместе с базой ([b975a79](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b975a79c6591e7ab4d29b846f21a3d282249c5a7))
* **cabinet:** устройства пропадали, пока не прогнан бэкфилл панельных id ([afb0d19](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/afb0d19d49e358d9330ae7758784183c3015fa2c))
* **campaign:** MissingGreenlet при начислении бонуса кампании на регистрации ([6ec45f6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6ec45f690f370b97c79615f914e3e6b9d8f87109))
...
* **channels:** таймаут прокси при проверке подписки не спамит админ-чат ([178c158](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/178c158cc09a7a5e9b988286b0276591746a3548))
* **ci:** lowercase-референс образа для Trivy-скана ([795c7be](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/795c7be735e6aaa61d2689d97c815346a090ae7b))
...
* **coupons:** закрыть double-tap на подтверждении партии и двойной answer в экспорте ([8947a73](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8947a73f9962366ed10ba8244b36c01cc93d4712))
...
* **email:** не тащить CSS/JS в text/plain версию письма ([#2974](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/2974)) ([7b9b7f1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7b9b7f1c36ef11502feca3c6405303084c2369a7))
* **email:** не тащить CSS/JS в text/plain версию письма ([#2974](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/2974)) ([e4af7f2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e4af7f2ecd28aab15af6397f97fce48b5b426bf7))
...
* **i18n:** исправление ошибок перевода в fa/ua/zh локалях ([2cc0f36](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2cc0f36dd89c68ee8499929ede93020932332c40))
* **l10n:** добавить недостающие ключи t() во все локали и защитить тестом ([3a0e54b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3a0e54bc4b9880726ae0ce20ec5e4d617ba7f44e))
* **lava:** взаимоисключение с Platega + сдвиг списания при ручном продлении ([da84ed1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/da84ed101e539031db5ad8178e6d7b8e5139ce6d))
* **lava:** закрыты находки адверсариального ревью рекуррента ([94e3fcd](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/94e3fcd3147a31520e7cf51ce2a47ef0a95421d2))
* **lava:** имя провайдера в правой части «через …» вместо имени метода ([df92f68](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/df92f68fc5d5ca099071b8d6310b3d7388db503a))
* **logs:** в логе ошибки соединения с БД не было видно, что именно случилось ([fc80c53](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fc80c534412393674cf4bc38e8e0ff772a24230f))
* **maintenance:** не разворачивать traceback для ожидаемых отказов Telegram ([27b02e4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/27b02e4f363914e8b0982d13c4a213ab4c1982d5))
* **menu:** кнопки таблицы в видимую строку + эфемерное подтверждение триала ([f7809b7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f7809b7b323ecbb493eae9f1f2b8f440c5869367))
* **menu:** не разворачивать traceback для ожидаемых ошибок rich-меню ([1ca972d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1ca972d6d6f01b18d474d9363eaae86294c797af))
* **menu:** не строить tg-time для дат вне 32-битного unix-диапазона Telegram ([e3dfcf7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e3dfcf726b08acc7ae1a63aa4efddb42f7aee752))
* **menu:** не строить tg-time для дат вне 32-битного unix-диапазона Telegram ([c0b932e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c0b932e71eeb4cfa6a31702f59d215ea934f35d6))
...
* **migrations:** keep upstream migrations numbered 0100+ (regex只 matched 00xx) ([ffff46f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ffff46fdbd63928b76fb4fe2fb6c775e9f4559aa))
...
* **monitoring:** поддержать плейсхолдер {days} в SUBSCRIPTION_EXPIRING_PAID ([d445dfa](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d445dfaf5ba72617711cdc6e2224f83b3c787a95))
* **monitoring:** поддержать плейсхолдер {days} в SUBSCRIPTION_EXPIRING_PAID ([bc51a06](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bc51a0624739b322c3e67d646ecfd3526385bb80))
* **nalogo:** print_url строил ссылку на чек без /v1 ([a472d11](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a472d11279f6fba23d7bdc771ced30a747aaa31f))
* **nalogo:** доставлять чек покупателю после ручной пересылки из админки ([fa25d70](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fa25d701a2227829f7d5ac087af77a68a31d145b))
* **nalogo:** дочитывать печатную форму чека до конца ([7dcd18e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7dcd18ec8a27a855b644ea1eab7d0b9989204f57))
* **nalogo:** не терять чек, если Telegram отверг файл, и не слать HTML как чек ([abde46c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/abde46cbe501c5d2712f2aaf2b2f61fc09085a5d))
* **nalogo:** ссылка на чек — добавлен /v1 (баг библиотечного print_url) ([a547f5c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a547f5cb5f6f83aa5f73ad24fec9df0b307f5a4d))
* **nalogo:** чек по подарочной покупке — адресат покупатель, а не одаряемый ([3a0a157](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3a0a157f35029c8c2e57b013147c74f33339059b))
* **notifications:** email-юзерам уведомления в flow "пополнение -&gt; автопокупка" ([#2952](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/2952)) ([d527ce5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d527ce57c5a29d314c8c59b94a670c8def0fe510))
* **notifications:** email-юзерам уведомления в flow «пополнение → автопокупка» ([#2952](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/2952)) ([083289d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/083289d7b1b9f83d6c1b5bf42bd17ee6d3218112))
...
* **notifications:** MissingGreenlet при уведомлении о регистрации по кампании ([0f1beff](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0f1beff51b284bae0183bb37000b860e82b4ee4e))
* **notifications:** вернуть заявки на вывод в свой топик (фолбэк PARTNERS) ([afd32a4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/afd32a40a71fe31f95f939113aa4e02c07168135))
* **nudge:** вся функция send_backup_login_nudge обёрнута в try/except ([3fa8a0a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3fa8a0ad05b98fab9817616466e46fc6e1678958))
* **platega:** actionable-ошибка при отказе создания СБП-подписки ([0864a95](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0864a95ec65f90cdcf60d2af9ff2265b3be51e0d))
* **platega:** side-effects после СБП-списания + защита от пустого charge Id и пропавшей подписки ([ee295c6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ee295c6a8dcd648f5c64b1aaea61fed238eee0d5))
* **platega:** аудит-фиксы СБП-автопродления — money-safety и полнота отмен ([ccc2049](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ccc2049c7d15dda6779ce6f74a6b807459275a72))
* **platega:** гонка конкурентного enable (D5) и outage-vs-404 в reconciler (D4) ([8243d39](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8243d3924e034e04ba83b61086a7e10a7ca02bdf))
* **platega:** идемпотентность создания СБП-подписки (не плодить дубли и двойные списания) ([132ef4e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/132ef4e19f0ba1f24fd4958e88d2a9ceb65945e0))
* **platega:** поддержка v2 API - поле url и настраиваемая версия эндпоинта ([#2934](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/2934)) ([681a1d2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/681a1d2fc38f5a17e5f6cb60964517df015462ba))
* **platega:** поддержка v2 API — поле url и настраиваемая версия эндпоинта ([#2934](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/2934)) ([7ff3b40](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7ff3b402c4423faecc8ca462208a352121a60d83))
* **platega:** санитайзить description подписки под 64-байтный лимит Platega ([f7a6f5b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f7a6f5b624856bed742373ea123648c58e9e2642))
* **platega:** СБП-автопродление доступно для суточных тарифов + гард на триал ([9fe42e7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9fe42e795c93cb26f75ca95e919adf983ac760c8))
* **platega:** синк панели после списания + обратное взаимоисключение + отмена на пропущенных путях удаления ([57ad9b7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/57ad9b746e53d82c8641b7c0ee47eaa210993c21))
* **platega:** три P2 из ревью релизного PR [#3111](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3111) ([64feac0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/64feac0aa8e5da90da38797a4d834fbcb350c2e2))
* **pricing:** корректная цена за месяц для коротких и некратных периодов ([9b172b2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9b172b2d7af1ee33ac132a9341c9f967a47ed7a2))
* **promo-offers:** счётчик сегмента expired — живая ветка вместо мёртвой ([d93762f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d93762ff0bcbd4834afc3f3bca858e63f53e08cd))
* **promocode:** MissingGreenlet при отказе активации — rollback экспирировал db_user хендлера ([d0c1d5d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d0c1d5dec2e828222d84d39d0e7aad83188abc5e))
...
* **recurrent:** цена автопродления учитывает докупки устройств и трафика ([85344c6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/85344c663e7c5f5b99761d8ad06aebdac7916a4f))
* **referral:** за первое пополнение реферер получает только фиксированный бонус ([5b05b19](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5b05b1947cfdd0dbc47d246d81c9f2ad07486301))
* **referral:** не терять реферера при регистрации через кабинет с входом по Telegram ([e53f3d7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e53f3d7d03722036a0c5e149d214e6c41265533b))
...
* **remnawave:** grace-сессия строки-донора не теряет идентичность ([dc09e78](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/dc09e78077d00c02b3dc3e16a4e846bcf1cbed30))
* **remnawave:** бэкфил не блокируется одной парой и отдаёт id живой строке ([5cd3adb](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5cd3adb5bd856ca54d984bb4f9f59ce33a097b0d))
* **remnawave:** бэкфил не откатывался целиком на single-tariff ([d461784](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d461784f3c70cb58c7dd11fc9c51b60be0190ae8))
* **remnawave:** бэкфилл падал на старте и брал не тот режим ([deeb24f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/deeb24fbcdd235f63892b50d2ca478b2c6ac6325))
* **remnawave:** бэкфилл привязывал чужой аккаунт, создание падало на индексе ([98e63b0](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/98e63b07b5c8e8c562c1e96936049f057257d2d8))
* **remnawave:** вебхук не проверял соседей, и подписи тестов врали ([70d35c1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/70d35c1afee123938ce833688120dc2397855d98))
* **remnawave:** защита от противоречивых uuid не работала на первом прогоне ([928ce20](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/928ce20a011618ee4793bc50c068eafde65e0946))
* **remnawave:** карта uuid не праймилась, холостой прогон писал в БД ([e9445ee](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e9445ee2f12c811965e4936687258d79152c707a))
* **remnawave:** клэмп size в 1..1000 для /api/users/stream ([7bf8047](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7bf8047e8bde7c56b55680cbc9e18f45f6765fc1))
* **remnawave:** кэш локальных happ crypt4 ссылок (стабильность между вызовами) ([0b54d59](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0b54d59d5a8741b393524cb00e13de0b84118a7c))
* **remnawave:** ложный успех при удалении устройств, окно суток и happ-ссылка ([b007de8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b007de8f4117d4626a03fd3c54316a1e34aaaee6))
* **remnawave:** не терять и не подсовывать протухшую идентичность подписки ([bef6e6d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bef6e6d7d1db65660800b58e7fc20856f40b0751))
* **remnawave:** несовпадение владельца снова вело к очистке, а не к перепривязке ([ea4db92](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ea4db928b3d9dd171af3d00b8f9c706d4cc47fca))
* **remnawave:** пересоздавать удалённого из панели юзера при живой подписке ([9f31282](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9f31282785c34d2f5a840c9b429360bba232358b))
* **remnawave:** повторный прогон бэкфила и выбор живой подписки ([b515c3d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b515c3d30bb762f89b425069d5685d8750168ce0))
* **remnawave:** поля, которых нет в контракте 3.0.0, и след прогона бэкфила ([babf846](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/babf84634d676a71e7c2b77f03ec7aadaefb391f))
* **remnawave:** порядок UPDATE'ов при переносе панельного id ([28b01f1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/28b01f1ee71841a2d9654e357c26729f8a6f09af))
* **remnawave:** протухший id больше не решает за пользователя ([83c6415](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/83c6415c11d007151dde99dfea61178382ba1e8a))
* **remnawave:** след прогона врал, а защита индекса не мешала записи в панель ([fe3dc5b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fe3dc5bb42cef0b1becbaa56c6ad9be3076c9276))
* **remnawave:** суточная проверка снова не сработала бы, а граница id ослабла ([3c31285](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3c31285a4c920b715dc57253c6525af82972a5b6))
* **remnawave:** точный ключ не должен проигрывать догадке и ронять синк ([d2fd3d5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/d2fd3d5db91ed82aea639b5602dc9f900aeaa18b))
* **remnawave:** холостой прогон бэкфила называл свой отчёт «conflicts» ([6b7204b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6b7204b1d5cf5a1a6e4cffa9972aef9f55995500))
...
* **rich-menu:** RICH_MESSAGE_DATE_INVALID на подписках дальше ~3 лет ([9ee31d3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9ee31d3d57e5fcac58bb26886b256ab62fb6884b))
* **rich-menu:** дать включить rich-меню без логотипа ([add7327](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/add7327d479202e8c12a232eeb7fd4b28157da25))
* **rich-menu:** премиум-эмодзи из текстов меню уходили клиенту сырым тегом ([1feab43](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1feab432bc4da949ecbf15e7729320990272af30))
* **search:** регистронезависимый поиск по юзерам для кириллицы ([5323803](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/53238035f72b4a1ee7554196d0899e9bde23d6df))
...
* **settings:** осмысленные категории для настроек, начинающихся с глагола ([e6f1505](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e6f150537ad57b24f95f9f7024d0d329c5cd6c56))
* **settings:** отображать DEVICES_SELECTION_DISABLED_AMOUNT как число, а не цену ([0f1968e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0f1968ec658148f0920bfaa253ea3c59c9f6df1f)), closes [#1658](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/1658)
...
* **startup:** однозначно широкие статус-значки в резюме запуска ([3dae638](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3dae638755499094d405601a9fe81eecf5389fbc))
* **start:** видео не доходило до самой команды /start ([1f61e0b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/1f61e0bec2686314f7e151b00d4b4e616e749329))
...
* **subscription:** device_limit = 0 — это безлимит, а не ноль устройств ([51688fc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/51688fc4573569dae2fe9855da93eeebb6d1188a))
...
* **subscription:** NameError при продлении тарифа после списания денег ([82b7131](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/82b7131154e93f2bc4719cae4c64c171648e0f96))
* **subscription:** renewal-строки хронологии брать дни из extended_days ([c605899](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c605899f892f54d13e0472b8569f59e7de5d7209))
* **subscription:** конверсия живого триала при покупке тарифа в мульти-режиме ([76aa67c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/76aa67cb5493e681515799ef3405618fa4c1c1c2))
* **subscription:** не показывать неоплаченный черновик триала как подписку ([fe992c6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fe992c65817eff1156f2f7d56232d59a1bf385fe))
...
* **support:** дефолты SLA в коде развести с .env.example не в пользу спама ([38110e5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/38110e50fee3a8d57f42c66a72f238582e5a2a28))
* **support:** отдавать внешний URL поддержки в конфиге кабинета ([b270349](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/b27034969f11d6bf41e4e8a81da351fabcb965f4))
* **support:** проверять бан поддержки и режим тикетов в веб-сокете ([f3acc69](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f3acc69a8fcae3efdbd5a18153a05a75473a4136))
* **support:** синхронизировать persisted-режим поддержки в settings при старте ([2184e58](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2184e58da48831c914ac68806baa13008d3f0a85))
...
* **tariff:** превью покупки считает цену тем же PricingEngine, что и confirm ([baef285](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/baef285194868a8c422833b37f33b0e941abc547))
* **tariff:** СБП-оформление доступно с экрана «недостаточно средств» ([a5a13ae](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/a5a13aea1d9249b4dc7eca8b1c4851e9acaa337e))
* **tickets:** передавать db в новые event_emitter-эмиссии кабинета ([8eaef7f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8eaef7f1ffbddc7947d591a87aaeaa643b3f9cfa))
* **tickets:** писать id реального админа в ticket_messages.user_id ([#3029](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3029)) ([eb326db](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/eb326db4f09029e2e6f4e5ac6ecc1f60d1ab5746))
* **tickets:** писать id реального админа в ticket_messages.user_id ([#3029](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3029)) ([fc92019](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fc92019c10c2c6712a4948539aaa24d2d5809b3e))
* **tickets:** проверять блокировку поддержки и лимит тикетов в кабинете ([2887ef7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2887ef70cadbe85b15e974429ac0e5d283c80515))
* **tickets:** режим поддержки в кабинете читать у сервиса, а не из settings ([bd93d7e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bd93d7e8ba7e3908fc73684c5782ef9d633fd065))
* **traffic:** в уведомлении о превышении показывать, кто именно нарушитель ([ff2cb00](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/ff2cb00b468a5e0105408f65d894b772d97f23ab))
* **trial:** подгружать tariff перед сериализацией ответа активации триала ([8c5b2e1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/8c5b2e10508f2a1779d13e38227554849274028f))
* **tribute:** per-событийный ключ идемпотентности вместо donation_request_id ([e9515ad](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/e9515adb725f121d5b13b174c6ea8933228fbb17))
* **v3-compat:** 202 с пустым телом, статистика трафика и шум KassaAI ([69a54f2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/69a54f28eef86a3438c4407ab5fae84bdf727565))
* **v3-compat:** client_sync мапит HWID-устройства по userId на v3 ([f251e78](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f251e78f8a2484143e1c81cf0f352b112cce8c28))
* **v3-compat:** disable/enable юзера падали на v3, когда remnawave_id ещё NULL ([fe00815](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/fe008155f88d7df33ef29ecb5824a46e850eb47b))
* **v3-compat:** expiry-fallback падал без remna_id + массовый бэкфилл панельных id ([c28c5a1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c28c5a123bda2653d1f7f55fcf1410b4c49b9b70))
* **v3-compat:** lookup-методы на v3 не разворачивали конверт {'response'} → дубль-создание юзера ([068f2bc](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/068f2bc83cfafede8605225b3ea85c9d7852d7c8))
* **v3-compat:** raw HWID-вызовы бот-хендлеров на v3 (устройства/сброс) ([209e6a1](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/209e6a1db979ee780f0c40be5235dc6b8af0639d))
* **v3-compat:** бэкфилл remna_id ронял синхронизацию подписок IllegalStateChangeError ([896d867](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/896d86754fb949e4e3ba6f41b54101725436dc6d))
* **v3-compat:** в кабинете не отображались подключённые устройства ([2042a0c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2042a0c6750599d9f9b779008d1a356f297f65b0))
* **v3-compat:** детект версии панели путал 2.8.x с v3 → 400 "Invalid uuid" ([44dd3b5](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/44dd3b56111c3a052218564c9dcdad0c7e8b3447))
* **v3-compat:** закрыть оставшиеся call-site'ы без remna_id + webhook v3 identity ([263887c](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/263887cee014495c26e7a8f2e7f15426649717e2))
* **v3-compat:** проба версии неверно определяла v3-панель как v2 ([f0030e7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f0030e72a741a735fb7755d6d386d17e37b2403f))
* **v3-compat:** сброс устройств падал TypeError — рассинхрон имени параметра ([5174e70](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5174e7021a31f0ad850fecffe10b678d10b72d24))
* **v3-compat:** синк в панель брал у найденного юзера только uuid, игнорируя id ([5146046](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/514604621c66b16b29f92f90fac372baade01d07))
* **v3-compat:** тело hwid-delete на v3 — поле userId(number), а не userUuid(string) ([0c3eb00](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0c3eb0038084563edb9c13f345493468014a7b67))
* **v3-compat:** устройства (HWID) в кабинете на v3 — резолв remna_id ([4e70f40](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/4e70f406ea77d84ebc209f2ea07a903f3dd1026f))
* **v3-compat:** устройства/ноды/история в админке, miniapp и device_ownership на v3 ([cd048f2](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cd048f20a515e73e86e552d6ccadab26d8914f70))
...
* восстановление затёртых dev-фич и фиксы grace-подсистемы (PR [#3075](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3075)) ([35206d7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/35206d7ba0bd9a2f5c17a42f49f3e919112d6773))
* сброс устройств при покупке и падение панельного синка на просроченной сессии ([3801e15](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3801e155a17dd633ff562776a76545d35ed7d0f4))
* удаление пользователя — 204 на v3 и каскад NOT NULL связей User ([2d6a8b8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/2d6a8b85e8f0ec6763edd5894310d0aa23ebef0f))
* устранить замечания CodeQL из PR [#3123](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3123) ([c7cc8b4](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/c7cc8b4585b94766be87fd5a260ec8f436a5b7a8))


### Performance

* **v3-compat:** не зондировать версию панели на каждый вызов get_api_client ([99b670f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/99b670fe7617c95e057ed413aed541e82cf26e05))
...
* **coupons:** единый build_coupon_deeplink вместо трёх копий формата ссылки ([bc5dfcf](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/bc5dfcf677fb4e167d5ce48b9cbf1e08f63a0d40))
...
* **trial:** вынести ядро активации триала в activate_paid_trial_core ([cbed86b](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/cbed86b4f63805f5bbaa6ebe269218b36e16c848))
...
* **plan:** план реализации хронологии подписки ([61f59ad](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/61f59ad1ad8d497b23c4810637f34d6bcb44c8b8))
...
* **platega:** отмена автооплаты, хук при удалении подписки, админка кабинета ([47f5252](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/47f5252ffcc188557907dfd8c0c20529c3f06ad6))
* **platega:** план реализации бэкенда+бота рекуррентных СБП (Plan A) ([7a8bd2e](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/7a8bd2ee1358f65e4f140f88194d6d02dfd77c83))
* **platega:** спека рекуррентных СБП-платежей Platega ([9f876aa](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9f876aa2836c15358995c31d092a86edd90e4467))
* **remnawave:** дизайн совместимости панели v2 и v3 ([6008d4a](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6008d4a5c6535ba7b64fcec188e33b9172c356d6))
* **remnawave:** план совместимости v2/v3 (7 задач) ([9daa4a3](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/9daa4a3036c5bc0aab8debafab340a53cdb02cf8))
* **remnawave:** точное обоснование раздельных flush при переносе id ([6eb80c6](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6eb80c6957987a48098bfffe2b11701dc4267285))
...
* **spec:** мягкая обязательная подписка + пуш свежего поста ([f6fa834](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/f6fa83482544564b524b75e0e3d0347f72cc2324))
* **spec:** резервный метод входа при оплате (фича B) ([5cdcce8](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/5cdcce8b7743ba0d352c1a94662c07bd891f76cb))
* **spec:** хронология подписки (история покупок/продлений) для юзера и админа ([6f0f53d](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/6f0f53d74de3a06722edb1dab90d8f866aeaad99))
* **tests:** valkey-образ содержит redis-* как compat-симлинки — уточнение докстринга ([0a435c7](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/0a435c79fbcbcfddac35256017a1cd7444d661b0))
* **trial:** дизайн и план авто-активации платного триала после пополнения ([2058704](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/20587040497da4f378cb6e0560f2f3a407d50e30))
* **valkey:** точные формулировки лицензий (7.4 = RSALv2/SSPLv1; AGPLv3 только с Redis 8) и симлинков в тестах ([23183cb](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/23183cbb363203662a4c4c8b0da4c06075a05349))
* актуализация комментария get_receipt_print_url после фикса библиотеки ([#3083](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/issues/3083)) ([3b4f37f](https://github.com/Gy9vin/remnawave-bedolaga-telegram-bot/commit/3b4f37fa247dcbe53c3545a8296662df0400dc38))
