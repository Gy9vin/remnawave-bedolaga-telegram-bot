...
def _make_user(
    *,
    ...
    used_promocodes: int | None = None,
    email_verification_token: str | None = None,
    email_verification_expires: datetime | None = None,
    email_change_new: str | None = None,
    email_change_code: str | None = None,
    email_change_expires: datetime | None = None,
    ...
    return SimpleNamespace(
        ...
        email_change_expires=email_change_expires,
