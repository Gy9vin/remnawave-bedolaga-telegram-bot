...
async def test_purchase_new_subscription_classic_mode():
    ...
    with (
        ...
        patch('app.database.crud.user.subtract_user_balance', return_value=True),
        patch('app.database.crud.subscription.create_paid_subscription') as mock_create_sub,
        patch('app.database.crud.subscription.add_subscription_servers'),
        patch('app.database.crud.server_squad.add_user_to_servers'),
        patch('app.database.crud.transaction.create_transaction'),
        patch('app.database.crud.user.get_user_by_id') as mock_get_user,
        patch('app.utils.user_utils.mark_user_as_had_paid_subscription'),
...
async def test_purchase_trial_conversion():
    ...
    with (
        ...
        patch('app.database.crud.subscription.calculate_subscription_total_cost') as mock_calc_cost,
        patch('app.database.crud.user.subtract_user_balance', return_value=True),
        patch('app.database.crud.subscription_conversion.create_subscription_conversion') as mock_conversion,
        patch('app.database.crud.subscription.add_subscription_servers'),
        patch('app.database.crud.server_squad.add_user_to_servers'),
        patch('app.database.crud.transaction.create_transaction'),
        patch('app.database.crud.user.get_user_by_id') as mock_get_user,
