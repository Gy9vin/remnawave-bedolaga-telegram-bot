...
async def get_admin_wheel_config(
    ...
    return AdminWheelConfigResponse(
        ...
        free_spin_enabled=getattr(config, 'free_spin_enabled', False),
        free_spins_per_period=getattr(config, 'free_spins_per_period', 1),
        free_spin_period_days=getattr(config, 'free_spin_period_days', 2),
        free_spin_requires_active_subscription=getattr(config, 'free_spin_requires_active_subscription', True),
